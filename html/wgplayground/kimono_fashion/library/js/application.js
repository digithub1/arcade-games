/*
* @author edapskov
* @copyright 2019 edapskov v 8.001
*/
function Application()
{
	...
	*/
	this.copyright = "© DL-Studio, v 8.001";
	/*
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					...
					stockings_2:{rewarded:false},
					stockings_3:{rewarded:false},
					stockings_4:{rewarded:false},
					stockings_5:{rewarded:false},
					stockings_6:{rewarded:false},
					...
					rightHand_0:{rewarded:false},
					rightHand_1:{rewarded:false},
					rightHand_2:{rewarded:false},
					rightHand_3:{rewarded:false},
					rightHand_4:{rewarded:false},
					rightHand_5:{rewarded:false},
					leftHand_0:{rewarded:false},
					leftHand_1:{rewarded:false},
					leftHand_2:{rewarded:false},
					leftHand_3:{rewarded:false},
					leftHand_4:{rewarded:false},
					leftHand_5:{rewarded:false},
					bg_0:{rewarded:false},
					bg_1:{rewarded:false}
				},
				currentDress:{
					...
					rightHand:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
					leftHand:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
		...
		if(_currentMainScreen_mc.locations_mc)
		{
			...
			*/
			if(_hasLabelInMovieClipFunc(locations_mc, targetLocation_str))
			{
				...
				*/
				if(locations_mc["frame_" + (locations_mc.currentFrame + 1) + "_mc"])
				{
					locations_mc = locations_mc["frame_" + (locations_mc.currentFrame + 1) + "_mc"];
					locations_mc.gotoAndStop(0);
				}
			}
			/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1675705252" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3690" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
