/*
* @author edapskov
* @copyright 2019 edapskov v 8.004
*/
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "Weird Dance on Wednesday";
	...
	*/
	this.copyright = "© DL-Studio, v 8.004";
	/*
				...
				*/
				if(_information.locations.hasOwnProperty(location_str))
				{
					if(_action_mc[location_str])
					{
						...
						*/
						if(_information.locations[location_str].completed)
						{
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1679589025" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
