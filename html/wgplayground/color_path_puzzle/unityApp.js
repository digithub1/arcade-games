const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/ColorPuzzle[13]-mirraSDK[5.1.20].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/ColorPuzzle[13]-mirraSDK[5.1.20].data.unityweb",
            frameworkUrl: buildUrl + "/ColorPuzzle[13]-mirraSDK[5.1.20].framework.js.unityweb",
            codeUrl: buildUrl + "/ColorPuzzle[13]-mirraSDK[5.1.20].wasm.unityweb",
