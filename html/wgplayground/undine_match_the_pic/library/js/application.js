...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Undine Match the Pic";
	...
	var _information = {
		...
		locations:{
			location_1:{
				...
				timer:120,
				areas:{
					area_0:{completed:null},
					area_1:{completed:null},
					area_2:{completed:null}
				},
				score:null
			},
			location_2:{
		...
		*/
		for(var propLocations in _information.locations)
		{
			if(_information.locations.hasOwnProperty(propLocations))
			{
				...
				*/
				if(_information.locations[propLocations].score == null)
				{
					_information.locations[propLocations].score = 0;
				}
			}
		}
	}
	...
	*/
			...
			*/
			if(_information.locations.hasOwnProperty(location_str))
			{
				if(currentScreen_mc.locations_mc[location_str])
				{
					...
					*/
					if(location_mc.stars_mc)
					{
						location_mc.stars_mc.gotoAndStop(0);
						location_mc.stars_mc.gotoAndStop(_information.locations[location_str].score);
					}
				}
				else
				{
	...
	function _onClickLocationFunc(event)
	{
		...
		*/
		new Edapskov_Flickering(_before, location_mc, ["#ffffff", "#ffffcc", "#ffccff"], 10, 12);
		/*
	...
	*/
	function _beginGameFunc()
	{
		...
		*/
		currentScreen_mc.popup_mc.gotoAndStop(0);
		currentScreen_mc.popup_mc.mouseEnabled = true;
		currentScreen_mc.popup_mc.mouseChildren = false;
		currentScreen_mc.popup_mc.cursor = "pointer";
		currentScreen_mc.popup_mc.addEventListener("click", _onClickStartLocationFunc, false);
		currentScreen_mc.popup_mc.visible = true;
		/*
		
		*/
		currentScreen_mc.windows_mc.gotoAndStop(0);
		currentScreen_mc.windows_mc.window_1_mc.gotoAndStop(0);
		currentScreen_mc.windows_mc.window_1_mc.picture_mc.gotoAndStop(0);
		currentScreen_mc.windows_mc.window_1_mc.picture_mc.addEventListener("click", _onClickPictureMCFunc, false);
		_updatePictureFiltersFunc(currentScreen_mc.windows_mc.window_1_mc.picture_mc, new createjs.BlurFilter(10, 10, 10));
		currentScreen_mc.windows_mc.window_1_mc.areas_mc.gotoAndStop(0);
		currentScreen_mc.windows_mc.window_2_mc.gotoAndStop(0);
		currentScreen_mc.windows_mc.window_2_mc.picture_mc.gotoAndStop(0);
		currentScreen_mc.windows_mc.window_2_mc.picture_mc.addEventListener("click", _onClickPictureMCFunc, false);
		_updatePictureFiltersFunc(currentScreen_mc.windows_mc.window_2_mc.picture_mc, new createjs.BlurFilter(10, 10, 10));
		currentScreen_mc.windows_mc.window_2_mc.areas_mc.gotoAndStop(0);
		/*
		
		*/
		_information.totalAreas = 0;
		_information.notFoundAreas = 0;
		for(var propAreas in _information.locations[_information.currentNameLocation].areas)
		{
			if(_information.locations[_information.currentNameLocation].areas.hasOwnProperty(propAreas))
			{
				/*
				
				*/
				_information.totalAreas++;
				_information.locations[_information.currentNameLocation].areas[propAreas].completed = false;
				/*
				
				*/
				if(currentScreen_mc.windows_mc.window_1_mc.areas_mc[propAreas])
				{
					area_mc = currentScreen_mc.windows_mc.window_1_mc.areas_mc[propAreas];
					area_mc.gotoAndStop(0);
					area_mc.name = propAreas;
					area_mc.mouseEnabled = true;
					area_mc.mouseChildren = false;
					area_mc.cursor = "default";
					area_mc.addEventListener("click", _onClickAreaMCFunc, false);
				}
				/*
				
				*/
				if(currentScreen_mc.windows_mc.window_2_mc.areas_mc[propAreas])
				{
					area_mc = currentScreen_mc.windows_mc.window_2_mc.areas_mc[propAreas];
					area_mc.gotoAndStop(0);
					area_mc.name = propAreas;
					area_mc.mouseEnabled = true;
					area_mc.mouseChildren = false;
		...
		*/
		currentScreen_mc.panel_mc.gotoAndStop(0);
		/*
		...
		*/
		...
		currentScreen_mc.panel_mc.timer_mc.gotoAndStop(0);
		currentScreen_mc.panel_mc.timer_mc.mouseEnabled = false;
		currentScreen_mc.panel_mc.timer_mc.mouseChildren = false;
		currentScreen_mc.panel_mc.timer_mc.simple_timer_comp.gotoAndStop(0);
		currentScreen_mc.panel_mc.timer_mc.simple_timer_comp.setValueFunc(_information.countTime);
	}
	/*
	...
	*/
	function _onClickStartLocationFunc(event)
	{
		...
		*/
		currentScreen_mc.popup_mc.mouseEnabled = false;
		currentScreen_mc.popup_mc.mouseChildren = false;
		currentScreen_mc.popup_mc.cursor = "default";
		currentScreen_mc.popup_mc.removeEventListener("click", _onClickStartLocationFunc, false);
		currentScreen_mc.popup_mc.visible = false;
		/*
		
		*/
		_updatePictureFiltersFunc(currentScreen_mc.windows_mc.window_1_mc.picture_mc, null);
		_updatePictureFiltersFunc(currentScreen_mc.windows_mc.window_2_mc.picture_mc, null);
		/*
	...
	*/
	function _onClickAreaMCFunc(event)
	{
		/*
		...
		*/
		var area_mc = event.currentTarget;
		var area_str = area_mc.name;
		/*
		
		*/
		var point_obj = area_mc.localToLocal(event.localX, event.localY, _stage);
		/*
		
		*/
		_information.locations[_information.currentNameLocation].areas[area_str].completed = true;
		/*
		
		*/
		if(currentScreen_mc.windows_mc.window_1_mc.areas_mc[area_str])
		{
			area_mc = currentScreen_mc.windows_mc.window_1_mc.areas_mc[area_str];
			area_mc.gotoAndStop(1);
			area_mc.mouseEnabled = false;
			area_mc.mouseChildren = false;
			area_mc.cursor = "default";
			area_mc.removeEventListener("click", _onClickAreaMCFunc, false);
		}
		/*
		
		*/
		if(currentScreen_mc.windows_mc.window_2_mc.areas_mc[area_str])
		{
			area_mc = currentScreen_mc.windows_mc.window_2_mc.areas_mc[area_str];
			area_mc.gotoAndStop(1);
			area_mc.mouseEnabled = false;
			area_mc.mouseChildren = false;
			area_mc.cursor = "default";
		...
		*/
		if(_information.notFoundAreas >= _information.totalAreas)
		{
			/*
			
			*/
			_soundManager.addSoundFunc("level_completed_sound", 0, 0, 0, 0.2, _soundManager.panFromStageFunc(point_obj.x, _CWIDTH));
			/*
		...
		{
			_soundManager.addSoundFunc("magic_sound", 0, 0, 0, 0.1, _soundManager.panFromStageFunc(point_obj.x, _CWIDTH));
		}
	}
	/*
	
	*/
	function _updateCounterFunc()
	{
		/*
		...
		*/
		currentScreen_mc.panel_mc.counter_mc.gotoAndStop(0);
		currentScreen_mc.panel_mc.counter_mc.not_found_mc.gotoAndStop(_information.notFoundAreas);
		currentScreen_mc.panel_mc.counter_mc.total_mc.gotoAndStop(_information.totalAreas);
	}
	/*
	...
	*/
	function _onTickIntervalFunc()
	{
		...
		*/
		_information.countTime--;
		/*
		
		*/
		if(_information.countTime <= 10)
		{
			_soundManager.addSoundFunc("tick_sound", 0, 0, 0, 0.4, 0);
		}
		/*
		...
		*/
		if(_information.countTime <= 0)
		{
			...
			*/
			currentScreen_mc.mouseEnabled = false;
			currentScreen_mc.mouseChildren = false;
			/*
	...
	*/
	function _onClickPictureMCFunc(event)
	{
		/*
		...
		*/
		if((currentDate_num - lastDate_num) < 500)
		{
			...
			*/
			_information.countTime -= 2;
			/*
			
			*/
			var point_obj = event.currentTarget.localToLocal(event.localX, event.localY, _stage);
			_soundManager.addSoundFunc("error_sound", 0, 0, 0, 0.3, _soundManager.panFromStageFunc(point_obj.x, _CWIDTH));
			/*
	...
	function _showFineFunc()
	{
		...
		*/
		currentScreen_mc.popup_mc.gotoAndStop(1);
		currentScreen_mc.popup_mc.mouseEnabled = true;
		currentScreen_mc.popup_mc.mouseChildren = false;
		currentScreen_mc.popup_mc.visible = true;
		/*
		...
		*/
		currentScreen_mc.popup_mc.fine_mc.gotoAndStop(0);
		currentScreen_mc.popup_mc.fine_mc.play();
		/*
		...
		*/
		...
		_information.timeout_id = setTimeout(_hideFineFunc, 1000);
	}
	function _hideFineFunc()
	{
		try
		{
			/*
	...
	*/
	function _completedLocationFunc()
	{
		...
		*/
		var share_num = _information.countTime / _information.locations[_information.currentNameLocation].timer;
		if((share_num >= 0) && (share_num < 0.33))
		{
			_information.locations[_information.currentNameLocation].score = 1;
		}
		if((share_num >= 0.33) && (share_num < 0.66))
		{
			_information.locations[_information.currentNameLocation].score = 2;
		}
		if((share_num >= 0.66) && (share_num < 1))
		{
			_information.locations[_information.currentNameLocation].score = 3;
		}
		/*
	...
	*/
	function _updatePictureFiltersFunc(displayObject_obj, filter_obj)
	{
		/*
		...
		*/
		var bounds_obj = displayObject_obj.getBounds();
		/*
		
		*/
		if(filter_obj == null)
		{
			displayObject_obj.filters = null;
		}
		else
		{
			displayObject_obj.filters = [filter_obj];
		}
		/*
		
		*/
		if(displayObject_obj.bitmapCache)
		{
			displayObject_obj.updateCache();
		}
		else
		{
			displayObject_obj.cache(bounds_obj.x, bounds_obj.y, bounds_obj.width, bounds_obj.height, 1);
		}
	}
	/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1653670866" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	function _lossFunc()
	{
		...
		*/
		_soundManager.addSoundFunc("loss_sound", 0, 0, 0, 0.1, 0);
		/*
		...
		*/
		var currentScreen_mc = new lib.LossScreen();
		_main.addChild(currentScreen_mc);
		currentScreen_mc.gotoAndStop(0);
		/*
		...
		*/
		currentScreen_mc.playAgain_btn.addEventListener("click", _onClickReplayBtnFunc, false);
		/*
	...
	*/
	function _winFunc()
	{
		...
		*/
		_soundManager.addSoundFunc("win_sound", 0, 0, 0, 0.1, 0);
		/*
		...
		*/
		var currentScreen_mc = new lib.WinScreen();
		_main.addChild(currentScreen_mc);
		currentScreen_mc.gotoAndStop(0);
		/*
