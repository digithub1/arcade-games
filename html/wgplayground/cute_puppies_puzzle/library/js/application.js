...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Cute Puppies Puzzle";
	...
	*/
	this.copyright = "© DL-Studio, v 5.2";
	/*
	...
	*/
	function _onResizeWindowFunc()
	{
		...
		*/
		...
		/*
		костыль для старых IOS на Яндексе
		*/
		if(!_information.hasOwnProperty("oldIOS"))
		{
			/*
			
			*/
			_information.oldIOS = false;
			/*
			...
			*/
			...
			{
				if(userAgent_str.indexOf("os 11_") >= 0 || userAgent_str.indexOf("os 12_") >= 0)
				{
					_information.oldIOS = true;
				}
			}
		}
		if(_information.oldIOS)
		{
			devicePixelRatio_num = 1;
			if(window.orientation == 90 || window.orientation == -90)
			{
				innerWidth_num = screen.height;
				innerHeight_num = screen.width;
			}
			else
			{
				innerWidth_num = screen.width;
				innerHeight_num = screen.height;
			}
		}
		/*
	...
	*/
	function _onClickPlayBtnFunc(event)
	{
		...
		*/
		var keyLocalStorage_str = _TITLE.replace(/[^a-z0-9]/gi, "").trim();
		...
		if(loadInformation_obj != null)
		{
			...
			{
				_information = loadInformation_obj;
			}
		}
		/*
	...
	*/
	function _puzzleFunc()
	{
		...
		*/
		var currentScreen_mc = new lib["LocationScreen_" + _information.currentLocation]();
		_main.addChild(currentScreen_mc);
		currentScreen_mc.gotoAndStop(0);
		/*
		...
		*/
		...
		currentScreen_mc.popup_mc.mouseChildren = true;
		currentScreen_mc.popup_mc.cursor = "pointer";
		currentScreen_mc.popup_mc.visible = true;
		currentScreen_mc.popup_mc.addEventListener("click", _onClickStartGamePopupFunc, false);
		/*
	...
	*/
	function _onClickStartGamePopupFunc(event)
	{
		...
		*/
		...
		_interval_id = setInterval(_onTickIntervalFunc, 1000);
		/*
	...
	*/
	function _onLoadPuzzleImageFunc(event)
	{
		...
		*/
		var tip_mc;
		if(currentScreen_mc.panel_mc.tip_mc)
		{
			tip_mc = currentScreen_mc.panel_mc.tip_mc;
		...
		*/
		var puzzle_mc = currentScreen_mc.panel_mc.puzzle_mc;
		puzzle_mc.gotoAndStop(0);
		...
		*/
		...
		currentScreen_mc.panel_mc.addChild(_level_1_mc);
		_level_1_mc.visible = false;
		/*
		
		*/
		_level_2_mc = new createjs.Container();
		currentScreen_mc.panel_mc.addChild(_level_2_mc);
		/*
		...
		*/
		var pocket_mc = currentScreen_mc.panel_mc.pocket_mc;
		pocket_mc.gotoAndStop(0);
		var pocket_bound = pocket_mc.getBounds();
	...
	*/
	...
	{
		var currentTarget_mc = event.currentTarget;
		var coord_point = _level_2_mc.globalToLocal(event.stageX, event.stageY);
	...
	*/
	function _deleteTipFunc()
	{
		...
		*/
		if(currentScreen_mc.panel_mc.tip_mc)
		{
			createjs.Tween.get(currentScreen_mc.panel_mc.tip_mc).wait(0).to({alpha:0.01, visible:false}, _DELAY * 1000);
		}
	}
	/*
	...
	*/
	function _completedPuzzleFunc()
	{
		...
		*/
		var keyLocalStorage_str = _TITLE.replace(/[^a-z0-9]/gi, "").trim();
		new Edapskov_LocalStorage().saveFunc(keyLocalStorage_str, _information);
		/*
		
		*/
		new Edapskov_Flickering(_before, currentScreen_mc.panel_mc, ["#ffffff", "#ffffcc"], 8, 24);
		/*
	...
	*/
	function _onTickIntervalFunc()
	{
		...
		*/
		var currentScreen_mc = _main.getChildAt(0);
		currentScreen_mc.simple_timer_comp.gotoAndStop(0);
		currentScreen_mc.simple_timer_comp.setValueFunc(_information.locations[_information.currentNameLocation].userIime);
	}
	/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1651854682" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	function _resultFunc()
	{
		...
		*/
		currentScreen_mc.photoContainer_mc.simple_timer_comp.gotoAndStop(0);
		currentScreen_mc.photoContainer_mc.simple_timer_comp.setValueFunc(_information.userIime);
		/*
		редирект
		*/
		/*
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3331" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
