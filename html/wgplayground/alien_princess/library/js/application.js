/*
* @author edapskov
* @copyright 2019 edapskov v 7.011
*/
function Application()
{
	...
	*/
	this.copyright = "© DL-Studio, v 7.011";
	/*
	...
	var _information = {
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					tattoo_0:{rewarded:false},
					tattoo_1:{rewarded:false},
					tattoo_2:{rewarded:false},
					tattoo_3:{rewarded:false},
					tattoo_4:{rewarded:false},
					tattoo_5:{rewarded:false},
					tattoo_6:{rewarded:false},
					...
					bracelet_0:{rewarded:false},
					bracelet_1:{rewarded:false},
					bracelet_2:{rewarded:false},
					bracelet_3:{rewarded:false},
					bracelet_4:{rewarded:false},
					bracelet_5:{rewarded:false},
					bracelet_6:{rewarded:false},
				...
				currentDress:{
					tattoo:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
					...
					eyebrows:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
					...
					bracelet:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
	...
	*/
	function _welcomeFunc()
	{
		...
		*/
		...
		{
			_updateHeroesFunc(currentScreen_mc.heroes_mc, true);
		}
		/*
	...
	*/
	function _selectFunc()
	{
		...
		*/
		_updateHeroesFunc(currentScreen_mc, true);
		/*
	...
	function _actionFunc()
	{
		...
		*/
		if(_information.locations[_information.currentNameLocation].actions.hasOwnProperty(_information.locations[_information.currentNameLocation].currentNameAction))
		{
			...
			*/
			_updateHeroesFunc(currentScreen_mc.body_mc, true);
			/*
		...
		*/
		if(_information.heroes[hero_str].currentDress[key].currentOption != val)
		{
			...
			*/
			if(key != "bg")
			{
				new Edapskov_Flickering(_before, currentScreen_mc.body_mc[hero_str][key], ["#ffffff", "#ffffcc"], 10, 18);
			}
			/*
	...
	*/
	...
	==============================================================================================================
	*/
	function _updateHeroesFunc(container_mc, firstRun_num)
	{
		/*
		
		*/
		if(firstRun_num === undefined)
		{
			firstRun_num = false;
		}
		else
		{
			firstRun_num = Boolean(firstRun_num);
		}
		/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1674584233" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	function _resultFunc()
	{
		...
		*/
		//_updateHeroesFunc(currentScreen_mc.photoContainer_mc, true);
		/*
		исключения
		*/
		currentScreen_mc.photoContainer_mc.heroes_mc.gotoAndStop(0);
		_updateHeroesFunc(currentScreen_mc.photoContainer_mc.heroes_mc, true);
		if(currentScreen_mc.photoContainer_mc.heroes_mc.container_1_mc)
		{
			...
			_updateHeroesFunc(currentScreen_mc.photoContainer_mc.heroes_mc.container_1_mc, true);
			currentScreen_mc.photoContainer_mc.heroes_mc.container_1_mc.play();
		}
		if(currentScreen_mc.photoContainer_mc.heroes_mc.container_2_mc)
		{
			...
			_updateHeroesFunc(currentScreen_mc.photoContainer_mc.heroes_mc.container_2_mc, true);
			currentScreen_mc.photoContainer_mc.heroes_mc.container_2_mc.play();
		}
		/*
	...
	*/
	...
	function _createBackupPhotoFunc()
	{
		...
		*/
		//_updateHeroesFunc(photoContainer_mc, true);
		/*
		исключения
		*/
		var currentScreen_mc = _main.getChildAt(0);
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3666" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
	function _onClickBannerMcFunc_2(event)
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3673" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
