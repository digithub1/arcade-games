...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Cute Little Dragon Creator";
		...
		heroes:{
			hero_1:{
				...
				dress:{
					...
					pattern:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					eyes:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					ears:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					...
					neck:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					faceart:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					comb:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1617902716" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	function _addAdsFunc()
	{
		if(_information.adsFlag)
		{
			...
			finally
			{
				...
				_information.timeout_id = setTimeout(_updateAdsFlagFunc, 120000);
			}
		}
	}
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=2722" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
	function _onClickBannerMcFunc_2(event)
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=2708" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
