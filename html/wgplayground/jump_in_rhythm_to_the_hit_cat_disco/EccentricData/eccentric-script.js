...
function showPromoGameModal(idGP, idYa, titleRu,titleEn) {
    ...
    if (isRussianLanguage()) {
        ...
        btnOpenPromoGame.href = `https://yandex.ru/games/app/${idYa}?lang=ru&ecc_promo_in_game=our_game_${idCurrentGame}`;
        ...
        btnOpenPromoGame.href = `https://yandex.com/games/app/${idYa}?lang=en&ecc_promo_in_game=our_game_${idCurrentGame}`;
