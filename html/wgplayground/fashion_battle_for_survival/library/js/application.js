...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Fashion Battle for Survival";
	...
	*/
	function _onTickCountDownFunc()
	{
		...
		*/
		_soundManager.addSoundFunc("tick_sound", 0, 0, 0, 0.1, 0);
		/*
		
		*/
		_currentMainScreen_mc.popup_mc.visible = true;
		_currentMainScreen_mc.popup_mc.countdown_mc.gotoAndStop(_information.countDown_uint);
	...
	*/
	function _givePrizeFunc()
	{
		...
		*/
		_soundManager.addSoundFunc("bonus_sound", 0, 0, 0, 0.2, 0);
		/*
	...
	*/
	function _onTickIndicatorFunc()
	{
		...
		*/
		...
		{
			_currentMainScreen_mc.indicator_mc.body_mc.gotoAndStop(Math.floor((_information.counter * _currentMainScreen_mc.indicator_mc.body_mc.totalFrames) / _information.timer));
		}
		else
		{
			/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1731522309" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
