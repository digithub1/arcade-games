function CInterface(){
    ...
    this._init = function(){      
        ...
        if (_fRequestFullScreen && screenfull.isEnabled){
            ...
            _pStartPosFullscreen = {x: oSprite.width/4 + 180,y:(oSprite.height/2)+4};
        ...
        _oTimeText = new createjs.Text(TEXT_TIME,"44px "+PRIMARY_FONT, "#0D94B0");
	...
	this._onLogoButRelease2 = function(){
        window.open("https://newkidsgames.org/?utm_source=WeeGoo&utm_medium=skibidi_toilet_jigsaw", target="_blank");
    };
