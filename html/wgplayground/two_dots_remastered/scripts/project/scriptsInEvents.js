...
const scriptsInEvents = {
	...
	async Gamesheet_Event318_Act2(runtime, localVars)
	{
	...
	async Gamesheet_Event472_Act3(runtime, localVars)
	{
		var a = JSON.stringify({"Moves":30,"Board":[2,1],"Used":["D4"],"Items":{"D4":[[0,0],[1,0]]},"Targets":[]});
		localVars.vValue = a;
	},

	async Gamesheet_Event497_Act3(runtime, localVars)
	{
	...
	async Gamesheet_Event498_Act3(runtime, localVars)
	{
		var a = JSON.stringify({"Moves":30,"Board":[3,2],"Used":["D1","D4"],"Items":{"D1":[[1,0],[0,1]],"D4":[[1,1],[2,1]]},"Targets":[]});
		localVars.vValue = a;
	},

	async Gamesheet_Event500_Act5(runtime, localVars)
	{
	...
	async Generalsheet_Event47_Act1(runtime, localVars)
	{
