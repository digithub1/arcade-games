...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "Starry Style Dorama of Dream";
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					...
					bottom_13:{rewarded:false},
					bottom_14:{rewarded:false},
					bottom_15:{rewarded:false},
					...
					bag_11:{rewarded:false},
					bag_12:{rewarded:false},
					bg_0:{rewarded:false},
					bg_1:{rewarded:false}
				},
				currentDress:{
					...
					hair:{currentOption:null, defaultOption:4, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
			...
			hero_2:{
				...
				totalDress:{
					...
					glasses_5:{rewarded:false},
					glasses_6:{rewarded:false},
					respirator_0:{rewarded:false},
					respirator_1:{rewarded:false},
					respirator_2:{rewarded:false},
					respirator_3:{rewarded:false},
					respirator_4:{rewarded:false},
					respirator_5:{rewarded:false},
					respirator_6:{rewarded:false},
					dress_0:{rewarded:false},
					dress_1:{rewarded:false},
					dress_2:{rewarded:false},
					dress_3:{rewarded:false},
	...
	*/
	function _preloaderFunc()
	{
		...
		*/
		...
		loadQueue.loadFile({id:"bell_sound", src:"library/sounds/bell_sound.ogg"});
		/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1743097755" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
