function CInterface(){
    ...
    this._init = function(){    
        ...
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite,s_oInteractiveStage);
        ...
        _oButSaveAsImg = new CGfxButton(_pStartPosSave.x, _pStartPosSave.y, oSprite,s_oInteractiveStage);
        ...
        _oButPrintAsImg = new CGfxButton(_pStartPosPrint.x, _pStartPosPrint.y, oSprite,s_oInteractiveStage);
        ...
        _oButRestart = new CGfxButton(_pStartPosRestart.x, _pStartPosRestart.y, oSprite,s_oInteractiveStage);
        _oButRestart.addEventListener(ON_MOUSE_UP, this._onButRestartRelease, this);
        
		var oSprite = s_oSpriteLibrary.getSprite('more_button');
        _pStartPosMore = {x: (oSprite.height/2)+ 20, y: 580};
        _oButMore = new CGfxButton(_pStartPosMore.x, _pStartPosMore.y, oSprite,s_oInteractiveStage);
        _oButMore.addEventListener(ON_MOUSE_UP, this._onButRestartRelease2, this);
       ...
       _oAreYouSureRestartPanel = new CAreYouSurePanel();
       _oAreYouSureRestartPanel.addEventListener(ON_BUT_YES_DOWN, this._onConfirmRestart, this);
    ...
    this.refreshButtonPos = function(iNewX,iNewY){
		...
		_oButMore.setPosition(_pStartPosMore.x + iNewX,iNewY + _pStartPosMore.y);
    ...
    this._onButRestartRelease = function(){
        _oAreYouSureRestartPanel.show(TEXT_ERASE_PAINT);
    };
    ...
    this._onConfirmRestart = function(){
        ...
        s_oGame.restartGame();
        _oAreYouSureRestartPanel.hide();
		
		Howler.mute(true);
		window[window.preroll.config.loaderObjectName].refetchAd(Howler.mute(!s_bAudioActive));
    };  
    ...
    this._onExit = function(){
          _oAreYouSurePanel.show(TEXT_SURE);
    };
	...
	this._onButRestartRelease2 = function(){
        window.open("https://newkidsgames.org/?utm_source=WeeGoo&utm_medium=coloring_book_valentine_pets", target="_blank");
    };
