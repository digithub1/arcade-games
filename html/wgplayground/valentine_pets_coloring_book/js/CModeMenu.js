function CModeMenu(){
    ...
    this._init = function(){
        ...
        _oTextChooseOutline = new createjs.Text(TEXT_CHOOSE," 80px "+PRIMARY_FONT, "#333333");
        ...
        _oTextChoose = new createjs.Text(TEXT_CHOOSE," 80px "+PRIMARY_FONT, "#ffcc00");
        ...
        var oShape = new createjs.Shape();
        oShape.graphics.beginStroke("#008df0").setStrokeStyle(16).drawRect(-iWidth/2, -iHeight/2, iWidth, iHeight);
        _oContainerImage1.addChild(oShape);
        ...
        var oShape = new createjs.Shape();
        oShape.graphics.beginStroke("#e93097").setStrokeStyle(16).drawRect(-iWidth/2, -iHeight/2, iWidth, iHeight);
        _oContainerImage2.addChild(oShape);
        ...
        var oShape = new createjs.Shape();
        oShape.graphics.beginStroke("#fb9700").setStrokeStyle(16).drawRect(-iWidth/2, -iHeight/2, iWidth, iHeight);
        _oContainerImage3.addChild(oShape);
        ...
        var oShape = new createjs.Shape();
        oShape.graphics.beginStroke("#309834").setStrokeStyle(16).drawRect(-iWidth/2, -iHeight/2, iWidth, iHeight);
        _oContainerImage4.addChild(oShape);
        ...
        var oShape = new createjs.Shape();
        oShape.graphics.beginStroke("#ea1c2d").setStrokeStyle(16).drawRect(-iWidth/2, -iHeight/2, iWidth, iHeight);
        _oContainerImage5.addChild(oShape);
        ...
        var oShape = new createjs.Shape();
        oShape.graphics.beginStroke("#6633cc").setStrokeStyle(16).drawRect(-iWidth/2, -iHeight/2, iWidth, iHeight);
        _oContainerImage6.addChild(oShape);
