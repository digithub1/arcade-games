function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("200x200", "./sprites/bg_preload.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./sprites/but_start.png");
        s_oSpriteLibrary.loadSprites();

        _oContainer = new createjs.Container();
        s_oInteractiveStage.addChild(_oContainer);
    };
    ...
    this.attachSprites = function () {
        ...
        oBg.graphics.beginFill("#111111").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
        ...
        _oIconMask.graphics.beginFill("rgba(21,21,21,0.01)").drawRoundRect(_oIcon.x - 960, _oIcon.y - 540, 1920, 1080, 10);
        ...
        _oMaskPreloader.graphics.beginFill("rgba(21,21,21,0.01)").drawRect(_oProgressBar.x, _oProgressBar.y, 1, _iMaskHeight);

        _oContainer.addChild(_oMaskPreloader);

        _oProgressBar.mask = _oMaskPreloader;

        _oLoadingText = new createjs.Text("", "50px " + PRIMARY_FONT, "#fff");
        ...
        _oButStart = new CTextButton(CANVAS_WIDTH/2, CANVAS_HEIGHT/2 + 300, oSprite, TEXT_PRELOADER_CONTINUE, PRIMARY_FONT, "#dc2110", 90, _oContainer);        
    ...
    this.refreshLoader = function (iPerc) {
        ...
        _oMaskPreloader.graphics.beginFill("rgba(21,21,21,0.01)").drawRect(_oProgressBar.x, _oProgressBar.y, iNewMaskWidth, _iMaskHeight);
    };
