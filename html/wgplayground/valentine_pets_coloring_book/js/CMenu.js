function CMenu(){
    ...
    this._init = function(){
        ...
        _oButPlay = new CTextButton((CANVAS_WIDTH/2),CANVAS_HEIGHT -400,oSprite,TEXT_PLAY,"BadaBoom","#981680",120);
        ...
        _oButCredits2 = new CTextButton((CANVAS_WIDTH/2),CANVAS_HEIGHT -200,oSprite,TEXT_MORE,"BadaBoom","#1a315e",95);
