...
function Application()
{
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					...
					headdress_13:{rewarded:false},
					headdress_14:{rewarded:false},
					headdress_15:{rewarded:false},
					headdress_16:{rewarded:false},
					headdress_17:{rewarded:false},
					headdress_18:{rewarded:false},
					headdress_19:{rewarded:false},
					bg_0:{rewarded:false},
					bg_1:{rewarded:false}
				},
				currentDress:{
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1744912996" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
