...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Chibi Troll Fashion Maker";
		...
		heroes:{
			hero_1:{
					...
					category_2:{
						...
						subcategories:{
							subcategory_1:{
								...
								fringe_13:{rewarded:false},
								fringe_14:{rewarded:false},
								fringe_15:{rewarded:false},
								fringe_16:{rewarded:false}
							},
							subcategory_2:{
					...
					category_4:{
						...
						subcategories:{
							subcategory_1:{
								...
								headdress_10:{rewarded:false},
								headdress_11:{rewarded:false},
								headdress_12:{rewarded:false}
							},
							subcategory_2:{
							...
							subcategory_3:{
								...
								jewelry_5:{rewarded:false},
								jewelry_6:{rewarded:false},
								jewelry_7:{rewarded:false},
								jewelry_8:{rewarded:false}
							}
						}
					},
					category_5:{
				...
				dress:{
					...
					bg:{currentOption:null, currentColor:null, defaultOption:2, defaultColor:null, totalOptions:null}
				}
			}
		}
	};
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dressupwho.net/html5/Blonde-Chibi-Fashion-Show" + "?utm_source=" + _getLocationFunc() + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
