...
function Application()
{
	...
	var _information = {
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					head_0:{rewarded:false},
					head_1:{rewarded:false},
					head_2:{rewarded:false},
					head_3:{rewarded:false},
					head_4:{rewarded:false},
					head_5:{rewarded:false},
					head_6:{rewarded:false},
					head_7:{rewarded:false},
					head_8:{rewarded:false},
					head_9:{rewarded:false},
					head_10:{rewarded:false},
					...
					eyes_9:{rewarded:false},
					eyes_10:{rewarded:false},
				...
				currentDress:{
					head:{currentOption:null, defaultOption:1, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1729869366" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
