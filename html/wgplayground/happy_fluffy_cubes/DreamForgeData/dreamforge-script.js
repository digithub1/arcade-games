...
function showLoginPanel() {
    ...
    switch (lang) {
        ...
        case "ja":
        case "ja-JP":
            textTitle.textContent = "認証";
            textMiddle.textContent = "進行状況を安全に保存するためにログインしてください";
            textDecline.textContent = "拒否";
            textAccept.textContent = "承認";
            break;
        default:
...
function showRequestReview() {
    ...
    switch (lang) {
        ...
        case "ja":
        case "ja-JP":
            textMiddle.textContent = "このゲームは好きですか？";
...
function addListenerForEscapeButton(onEscapeButtonPressedPtr) {
    function callUnityEscapeCallback() {
        console.log("JS: Пользователь нажал Escape");
