...
game.level.stageMenu5 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("stageMenu5");
		this.var = {};
        // Put user code here //
        me.game.viewport.fadeOut("#000000", 400);
        this.selisihHeightLayar = me.game.viewport.height/2 - me.game.world.height/2;
        
        this.level = me.pool.pull("levelContainerAsia", me.game.viewport.width / 2, me.game.viewport.height / 2);
