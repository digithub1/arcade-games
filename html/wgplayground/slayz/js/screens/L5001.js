...
game.level.L5001 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L5001");
		this.var = {};
        // Put user code here //
        ...
        let pohonKanan = me.pool.pull("L5001_PohonKanan", 407, 168);
        me.game.world.addChild(pohonKanan, 11);
        
        let pohonKiri = me.pool.pull("L5001_PohonKiri", -417, 175);
        me.game.world.addChild(pohonKiri, 11);
        
        let bis = me.pool.pull("L5001_Bis", -485.5, -62.5);
        me.game.world.addChild(bis, 11);
        
        let batu = me.pool.pull("L5001_Batu1", -290, 80);
        me.game.world.addChild(batu, 11);
        
        let batu2 = me.pool.pull("L5001_Batu2", 240, -220);
        me.game.world.addChild(batu2, 5);
        
        let monas = me.pool.pull("L5001_Monas", 373, -107.5);
        me.game.world.addChild(monas, 4);
        
        let tembok = me.pool.pull("TembokTransparant", -290, 80);
        me.game.world.addChild(tembok, 11);
        
        this.spawnerEnemy = me.pool.pull ("spawnerEnemy", 0, -375,{//0,-600
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", -250, -375,{//-1500, -265
                level:currentLevel,
                container:this
            });
