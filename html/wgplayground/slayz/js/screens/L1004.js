...
game.level.L1004 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L1004");
		this.var = {};
        // Put user code here //
        ...
        me.audio.play("sfx-pantai2", true, null, game.user.userData.sound.SFX);
        ...
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", -650, -165,{//-1350, -300
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", 650, -100,{//1350, -480
                level:currentLevel,
                container:this
            });
        ...
        let awanAtas = me.pool.pull ("awan1", -me.game.world.width+(-me.game.world.width/2), -150);
        me.game.world.addChild(awanAtas, 50);
        let awanBawah = me.pool.pull ("awan2", -me.game.world.width, 75);
        me.game.world.addChild(awanBawah, 50);
        awanAtas.tween();
        awanBawah.tween();
        
        let lampu = me.pool.pull ("L1004Lampu", -370, -105);
        me.game.world.addChild(lampu, 10);
        lampu.tween();
        let libertyHand = me.pool.pull ("L1004LibertyHand", -360, -175);
        me.game.world.addChild(libertyHand, 9);
        let libertyHead = me.pool.pull ("L1004LibertyHead", -100, -125);
        me.game.world.addChild(libertyHead, 9);
    ...
    decisionFunc: function(){
        let arrayX  = [-me.game.world.width/4, me.game.world.width/4-25],
            arrayY  = [15, -162.5];
