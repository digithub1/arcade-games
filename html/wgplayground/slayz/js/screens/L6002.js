...
game.level.L6002 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L6002");
		this.var = {};
        // Put user code here //
        ...
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", 650, -195,{level:currentLevel, container:this});
        this.spawnerEnemy5 = me.pool.pull ("spawnerEnemy", -650, -185,{level:currentLevel, container:this});
        ...
        this.waitKangaroo = me.timer.setTimeout(()=>{
            if(toKangaroo){
                ...
                this.kangarooSpawn2 = me.pool.pull ("Z035", -650, -185);
        ...
        let shakeBackground = me.pool.pull("me.Sprite", me.game.world.width, me.game.world.height, {
            ...
            region: "L6002_background"
        });
        me.game.world.addChild(shakeBackground, 3);
        game.util.scale(shakeBackground, 2);
            
        let bisShake = me.pool.pull("me.Sprite", me.game.viewport.width/2+450, me.game.viewport.height/2-selisihHeightLayar-20, {
                image: game.textureMap.get("australia"),
                region: "L6002_bis"
            }),
            mobilShake = me.pool.pull("me.Sprite", me.game.viewport.width/2-450, me.game.viewport.height/2-selisihHeightLayar+25, {
                image: game.textureMap.get("australia"),
                region: "L6002_mobil"
            }),
            bis = me.pool.pull ("L6002Bis", 450, -20),
            mobil = me.pool.pull ("L6002Mobil", -450, 25),
            pasir = me.pool.pull ("australiaPasir", -me.game.viewport.width, 0);
            me.game.world.addChild(bisShake, 5);
            me.game.world.addChild(mobilShake, 5);
            me.game.world.addChild(bis, 4);
            me.game.world.addChild(mobil, 4);
