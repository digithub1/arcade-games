...
game.level.L4001 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L4001");
		this.var = {};
        // Put user code here //
        ...
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", 650, 30,{level:currentLevel, container:this});
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", 130, -375,{level:currentLevel, container:this});
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", -130, -375,{level:currentLevel, container:this});
        ...
        let shakeBackground = me.pool.pull("me.Sprite", me.game.world.width, me.game.world.height, {
            ...
            region: "L4001_desert village preview"
        });
        me.game.world.addChild(shakeBackground, 3);
        game.util.scale(shakeBackground, 2);
        
        let gedungKananShake = me.pool.pull("me.Sprite", me.game.world.width-156, me.game.viewport.height/2-selisihHeightLayar-154, {
                image: game.textureMap.get("africa"),
                region: "L4001_gedung kanan"
            }),
            gedungKiriShake = me.pool.pull("me.Sprite", 160.5, me.game.viewport.height/2-selisihHeightLayar-131, {
                image: game.textureMap.get("africa"),
                region: "L4001_gedung kiri"
            }),
            barrelShake = me.pool.pull("me.Sprite", me.game.viewport.width/2-220, me.game.viewport.height/2-selisihHeightLayar-80, {
                image: game.textureMap.get("africa"),
                region: "L4001_container"
            }),
            gedungKanan = me.pool.pull ("L4001_GedungKanan", me.game.world.width/2-156, -154),
            gedungKiri = me.pool.pull ("L4001_GedungKiri", -me.game.world.width/2+160.5, -131),
            barrel = me.pool.pull ("L4001_Barrel", -220, -80),
            pasir = me.pool.pull ("africaPasir", -me.game.viewport.width, 0);
        me.game.world.addChild(gedungKananShake, 5);
        me.game.world.addChild(gedungKiriShake, 5);
        me.game.world.addChild(barrelShake, 7);
        me.game.world.addChild(gedungKanan, 4);
        me.game.world.addChild(gedungKiri, 4);
        me.game.world.addChild(barrel, 6);
