...
game.level.L4004 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L4004");
		this.var = {};
        // Put user code here //
        ...
        let shakeBackground = me.pool.pull("me.Sprite", me.game.world.width, me.game.world.height, {
            ...
            region: "L4004_pharaohBG"
        });
        me.game.world.addChild(shakeBackground, 3);
        game.util.scale(shakeBackground, 2);
        
        //spawner zombie
        this.spawnerEnemy = me.pool.pull ("spawnerEnemy", -650, 30,{level:currentLevel, container:this});
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", 650, -20,{level:currentLevel, container:this});
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", 100, -425,{level:currentLevel, container:this});
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", -100, -425,{level:currentLevel, container:this});
        ...
        let image = me.loader.getImage("api"),
            x = me.game.viewport.height/2 - me.game.world.height/2,
            y = x+176.25,
            emitter = new me.ParticleEmitter(197.5, y, {
                image: image,
                width: 25,
                totalParticles: 200,
                angle: 1.55,
            ...
            emitter2 = new me.ParticleEmitter(950, y, {
                image: image,
                width: 25,
                totalParticles: 200,
                angle: 1.55,
        ...
        let toOnce3 = true;
        this.timeOt3 = me.timer.setTimeout(function() {
            if(toOnce3){
                toOnce3 = false;
                me.game.world.addChild(emitter, 6);
                emitter.streamParticles();
                me.game.world.addChild(emitter2, 6);
                emitter2.streamParticles();
            }
        }, 10000);
        
        let dindingKananShake = me.pool.pull("me.Sprite", me.game.world.width-191.25, me.game.viewport.height/2-selisihHeightLayar-me.game.world.height/2+135.25, {
                image: game.textureMap.get("africa"),
                region: "L4004_TEMBOK KANAN"
            }),
            dindingKiriShake = me.pool.pull("me.Sprite", 191.5, me.game.viewport.height/2-selisihHeightLayar-me.game.world.height/2+135, {
                image: game.textureMap.get("africa"),
                region: "L4004_TEMBOK KIRI"
            }),
            batuShake = me.pool.pull("me.Sprite", me.game.world.width-79.5, me.game.viewport.height/2-selisihHeightLayar+72.5, {
                image: game.textureMap.get("africa"),
                region: "L4004_PILAR"
            }),
            dindingKanan = me.pool.pull ("L4004_dindingKiri", -me.game.world.width/2+191.5, -me.game.world.height/2+135),
            dindingKiri = me.pool.pull ("L4004_dindingKanan", me.game.world.width/2-191.25, -me.game.world.height/2+135.25),
            batu = me.pool.pull ("L4004_batu", me.game.world.width/2-79.5, 72.5),
            pasir = me.pool.pull ("africaPasir", -me.game.viewport.width, 0);
        me.game.world.addChild(dindingKananShake, 5);
        me.game.world.addChild(dindingKiriShake, 5);
        me.game.world.addChild(batuShake, 5);
        me.game.world.addChild(dindingKanan, 4);
        me.game.world.addChild(dindingKiri, 4);
        me.game.world.addChild(batu, 4);
