...
game.level.L2002 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L2002");
		this.var = {};
        // Put user code here //
        ...
        this.spawnerEnemy = me.pool.pull ("spawnerEnemy", 175, -375,{//350, -900
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", -150, -375,{//-300, -900
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", -650, 0,{//-1600, 0
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", 650, 0,{//1600, 0
                level:currentLevel,
                container:this
            });
        ...
        let batu = me.pool.pull("L2002Batu", -5, -112.5);
        me.game.world.addChild(batu, 8);
        
        let gedungKanan = me.pool.pull("L2002GedungKanan", 522.5, -172.5);
        me.game.world.addChild(gedungKanan, 8);
        
        let gedungKiri = me.pool.pull("L2002GedungKiri", -522.5, -165);
        me.game.world.addChild(gedungKiri, 7);
        
        let mobil = me.pool.pull("L2002Mobil", -400, -219);
        me.game.world.addChild(mobil, 8);
        
        let petirEffect = me.pool.pull("L2002BckgrndPetir", 0, 0);
        me.game.world.addChild(petirEffect, 9);
        this.interval1 = me.timer.setInterval(()=>{
            petirEffect.playTween();
            me.audio.play("sfx-thunder2", false, null, game.user.userData.sound.SFX);
        },10000);
	...
	onDestroyEvent: function() {
        ...
        me.timer.clearInterval(this.interval1);
