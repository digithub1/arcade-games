...
game.level.stageMenu6 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("stageMenu6");
		this.var = {};
        // Put user code here //
        me.game.viewport.fadeOut("#000000", 400);
        this.selisihHeightLayar = me.game.viewport.height/2 - me.game.world.height/2;
        
        this.level = me.pool.pull("levelContainerAustralia", me.game.viewport.width / 2, me.game.viewport.height / 2);
