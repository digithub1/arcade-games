...
game.level.L6001 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L6001");
		this.var = {};
        // Put user code here //
        ...
        //spawner zombie
        this.spawnerEnemy = me.pool.pull ("spawnerEnemy", 250, -375,{level:currentLevel, container:this});
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", 0, -375,{level:currentLevel, container:this});
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", -250, -375,{level:currentLevel, container:this});
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", 650, 20,{level:currentLevel, container:this});
        this.spawnerEnemy5 = me.pool.pull ("spawnerEnemy", -650, 20,{level:currentLevel, container:this});
        ...
        this.waitKangaroo = me.timer.setTimeout(()=>{
            if(toKangaroo){
                toKangaroo = false;
                this.kangarooSpawn = me.pool.pull ("Z035", 150, -375);
                this.kangarooSpawn2 = me.pool.pull ("Z035", -650, 20);
                this.kangarooSpawn3 = me.pool.pull ("Z035", -150, -375);
        ...
        let pohonKiriShake = me.pool.pull("me.Sprite", me.game.viewport.width/2-450, me.game.viewport.height/2-selisihHeightLayar-130, {
                image: game.textureMap.get("australia"),
                region: "L6001_pohon"
            }),
            dahanKananShake = me.pool.pull("me.Sprite", me.game.viewport.width/2+475, me.game.viewport.height/2-selisihHeightLayar-155, {
                image: game.textureMap.get("australia"),
                region: "L6001_batang"
            }),
            pohonKiri = me.pool.pull ("L6001pohonKiri", -450, -130),
            dahanKanan = me.pool.pull ("L6001dahanKanan", 475, -155),
            pasir = me.pool.pull ("australiaPasir", -me.game.viewport.width, 0);
            me.game.world.addChild(pohonKiriShake, 5);
            me.game.world.addChild(dahanKananShake, 5);
            me.game.world.addChild(pohonKiri, 4);
            me.game.world.addChild(dahanKanan, 4);
