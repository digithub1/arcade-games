...
game.level.L4002 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L4002");
		this.var = {};
        // Put user code here //
        ...
        //spawner zombie
        this.spawnerEnemy = me.pool.pull ("spawnerEnemy", -650, -10,{level:currentLevel, container:this});
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", 650, 50,{level:currentLevel, container:this});
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", 0, -425,{level:currentLevel, container:this});
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", -350, -425,{level:currentLevel, container:this});
        ...
        let shakeBackground = me.pool.pull("me.Sprite", me.game.world.width, me.game.world.height, {
            ...
            region: "L4002_sphinxbg"
        });
        me.game.world.addChild(shakeBackground, 3);
        game.util.scale(shakeBackground, 2);
        
        let kakiKananShake = me.pool.pull("me.Sprite", me.game.world.width/2+200, me.game.viewport.height/2-selisihHeightLayar-135, {
                image: game.textureMap.get("africa"),
                region: "L4002_kaki kanan"
            }),
            kakiKiriShake = me.pool.pull("me.Sprite", me.game.world.width/2-210, me.game.viewport.height/2-selisihHeightLayar-140, {
                image: game.textureMap.get("africa"),
                region: "L4002_kaki kiri"
            }),
            kepalaShake = me.pool.pull("me.Sprite", me.game.viewport.width/2+410, me.game.viewport.height/2-selisihHeightLayar-140, {
                image: game.textureMap.get("africa"),
                region: "L4002_kpala"
            }),
            batuShake = me.pool.pull("me.Sprite", 89, me.game.viewport.height/2-selisihHeightLayar+105, {
                image: game.textureMap.get("africa"),
                region: "L4002_PILAR 1"
            }),
            kakiKanan = me.pool.pull ("L4002_kakiKanan", 200, -135),
            kakiKiri = me.pool.pull ("L4002_kakiKiri", -210, -140),
            kepala = me.pool.pull ("L4002_kepala", 410, -140),
            batu = me.pool.pull ("L4002_batu", -me.game.world.width/2+89, 105),
            pasir = me.pool.pull ("africaPasir", -me.game.viewport.width, 0);
        me.game.world.addChild(kakiKananShake, 5);
        me.game.world.addChild(kakiKiriShake, 5);
        me.game.world.addChild(kepalaShake, 6);
        me.game.world.addChild(batuShake, 5);
        me.game.world.addChild(kakiKanan, 4);
        me.game.world.addChild(kakiKiri, 4);
        me.game.world.addChild(kepala, 5);
