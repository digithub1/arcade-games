...
game.level.L1002 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L1002");
		this.var = {};
        // Put user code here //
        ...
        this.spawnerEnemy = me.pool.pull ("spawnerEnemy", -150, -375,{//0, -600
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", -650, 0,{//-1350, -300
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", 650, -120,{//1350, -480
                level:currentLevel,
                container:this
            });
        let toOnce2 = true;
        ...
        this.spawnerEnemyBos = me.pool.pull ("spawnerEnemyBos", 0, -300,{
            level:currentLevel,
            container:this
        });
        ...
        let hydrant = me.pool.pull ("hydrant", -392.5, -51.5);
        me.game.world.addChild(hydrant, 9);
        
        let smallTrafficLight = me.pool.pull ("lampuMerahKecil", -340, -92.5);
        me.game.world.addChild(smallTrafficLight, 11);
        
        let bigTrafficLight = me.pool.pull ("lampuMerahBesar", 210, -145);
        me.game.world.addChild(bigTrafficLight, 11);
        
        let car = me.pool.pull ("carBlue", 125, -165);
        me.game.world.addChild(car, 11);
        
        let policeCar = me.pool.pull ("carPolice1", -225, -30);
        me.game.world.addChild(policeCar, 11);
        policeCar.playTween();
        
        let pohonLeft = me.pool.pull ("pohon3", -500, 125);
        me.game.world.addChild(pohonLeft, 20);
        
        let pohonRight = me.pool.pull ("pohon2", 500, 125);
        me.game.world.addChild(pohonRight, 20);
        
        let pohonKanan = me.pool.pull("pohonShadowKanan", pohonRight.pos.x, pohonRight.pos.y-30);
        me.game.world.addChild(pohonKanan, 12);
        
        let pohonKiri = me.pool.pull("pohonShadowKiri", pohonLeft.pos.x, pohonLeft.pos.y-5);
    ...
    decisionFunc: function(){
        let arrayX  = [-150, 150],
            arrayY  = [-225, -12.5];
        if(this.spawnerEnemy.spawnZ007 && this.spawnerEnemy2.spawnZ007 && this.spawnerEnemy3.spawnZ007 && this.Z007On){
            this.Z007On = false;
            ...
            me.timer.setTimeout(()=>{this.Z007On = true}, 20000);
        }
        ...
        if(this.spawnerEnemy.end && this.spawnerEnemy2.end && this.spawnerEnemy3.end && this.spawnerEnemyZ007.end){
