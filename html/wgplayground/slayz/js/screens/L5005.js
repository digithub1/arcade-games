...
game.level.L5005 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L5005");
		this.var = {};
        // Put user code here //
        ...
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", 150, -375,{//0,-600
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", -650, 75,{//-1500, -265
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", 650, 75,{//1500, -480
                level:currentLevel,
                container:this
            });
        let toOnce2 = true;
