...
game.level.L2001 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L2001");
		this.var = {};
        // Put user code here //
        ...
        me.audio.play("sfx-pantai1", true, null, game.user.userData.sound.SFX);
        ...
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", -250, -375,{//-1700, -300
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", 650, -200,{//1700, -300
                level:currentLevel,
                container:this
            });
        let toOnce2 = true;
        ...
        let batu1 = me.pool.pull("L2001Batu1", -275, -20);
        me.game.world.addChild(batu1, 7);

        let batu2 = me.pool.pull("L2001Batu2", 185, -30);
        me.game.world.addChild(batu2, 9);

        let bis = me.pool.pull("L2001Bis", -500, 55);
        me.game.world.addChild(bis, 9);

        let car1 = me.pool.pull("L2001Car1", 550, 40);
        me.game.world.addChild(car1, 9);

        let car2 = me.pool.pull("L2001Car2", 500, 165);
        me.game.world.addChild(car2, 9);

        let pohonKanan = me.pool.pull("L2001PohonKanan", me.game.world.width/2-35, -217.5);
        me.game.world.addChild(pohonKanan, 20);
        
        let pohonKiri = me.pool.pull("L2001PohonKiri", -me.game.world.width/2+40, -200);
        me.game.world.addChild(pohonKiri, 20);
        
        let policeCar = me.pool.pull("L2001PoliceCar", -300, 80);
        me.game.world.addChild(policeCar, 8);
        
        let laut = me.pool.pull("L2001Laut", 0, -me.game.world.height/2+65);
        me.game.world.addChild(laut, 5);
        laut.playTween();
        
        let pasir = me.pool.pull("L2001Pasir", -me.game.world.width, 0);
        me.game.world.addChild(pasir, 90);
        pasir.playTween();
