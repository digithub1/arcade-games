...
game.level.L3004 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L3004");
		this.var = {};
        // Put user code here //
        ...
        let area1 = me.pool.pull ("skill2Area", 0, me.game.world.height/2),
            ...
            // fireSpawn = me.pool.pull("battleFireButton", me.game.viewport.width/2, me.game.viewport.height/2, {con:this});
        ...
        // me.game.world.addChild(fireSpawn, 10);
        ...
        //--Spawner
        this.spawnerEnemy = me.pool.pull ("spawnerEnemy", -125, -375,{
            level:currentLevel,
            container:this
        });
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", 125, -375,{
            level:currentLevel,
            container:this
        });
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", -650, -30,{
            level:currentLevel,
            container:this
        });
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", 650, -30,{
            level:currentLevel,
            container:this
        });
        let toOnce2 = true;
        ...
        let penghalang = me.pool.pull('penghalang', -480, 100);
        me.game.world.addChild(penghalang, 5);
        
        let penghalang2 = me.pool.pull('penghalang', 480, 100);
        me.game.world.addChild(penghalang2, 5);
        penghalang2.flipX(true);
        
        let tempatDuduk = me.pool.pull('tempatDuduk', -370, -150);
        me.game.world.addChild(tempatDuduk, 5);
        
        let tempatDuduk2 = me.pool.pull('tempatDuduk', 370, -150);
        me.game.world.addChild(tempatDuduk2, 5);
        tempatDuduk2.flipX(true);
