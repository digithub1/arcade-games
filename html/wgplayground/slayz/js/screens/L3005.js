...
game.level.L3005 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L3005");
		this.var = {};
        // Put user code here //
        ...
        this.spawnerEnemy = me.pool.pull ("spawnerEnemy", 150, -375,{
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", -150, -375,{
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", -650, -50,{
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", 650, -50,{
                level:currentLevel,
                container:this
            });
        let toOnce2 = true;
        ...
        let pilarKanan = me.pool.pull('pilarKanan', 417.5, -165);
        ...
        let pasir = me.pool.pull ("australiaPasir", -me.game.viewport.width, 0);
