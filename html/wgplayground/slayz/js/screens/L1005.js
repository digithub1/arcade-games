...
game.level.L1005 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L1005");
		this.var = {};
        // Put user code here //
        ...
        this.spawnerEnemy = me.pool.pull ("spawnerEnemy", -400, -375,{
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy2 = me.pool.pull ("spawnerEnemy", -75, -375,{
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", 75, -375,{
                level:currentLevel,
                container:this
            });
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", 400, -375,{
                level:currentLevel,
                container:this
            });
        ...
        this.atap = me.pool.pull ("L1005Atap", 0, -228.5);
        me.game.world.addChild(this.atap, 12);
        
        let dinding = me.pool.pull ("L1005Tembok", 0, -146.5);
        me.game.world.addChild(dinding, 11);
        
        this.tiang = me.pool.pull ("L1005Tiang", -5, -141.5);
        me.game.world.addChild(this.tiang, 9);
        
        this.atapHancur = me.pool.pull ("L1005PintuJebol", 9999, 9999);
        me.game.world.addChild(this.atapHancur, 9);
        
        let pohon = me.pool.pull ("L1005Pohon", -me.game.world.width/2+110, -me.game.world.height/2+52.5);
        me.game.world.addChild(pohon, 50);
    ...
    decisionFunc: function(){
        let arrayX  = [275, -350],
            arrayY  = [-25, -25];
        if(this.spawnerEnemy.spawnZ007 && this.spawnerEnemy2.spawnZ007 && this.spawnerEnemy3.spawnZ007 && this.spawnerEnemy4.spawnZ007 && this.Z007On){
            this.Z007On = false;
        ...
        if(this.spawnerEnemy.bos2 && this.spawnerEnemy2.bos2 && this.spawnerEnemy3.bos2 && this.spawnerEnemy4.bos2){
            ...
            me.game.viewport.shake(50, 2000, me.game.viewport.AXIS.BOTH,()=>{
                ...
                this.timeOt3 = me.timer.setTimeout(()=>{
                    if(toOnce3){
                        toOnce3 = false;
                        this.atap.pos.set(this.atap.pos.x+9999, this.atap.pos.y+9999, 3);
                        this.tiang.pos.set(this.tiang.pos.x+9999, this.tiang.pos.y+9999, 3);
                        this.atapHancur.pos.set(this.atapHancur.pos.x-9979, this.atapHancur.pos.y-10149.5, 4);
                    }
                },900);
                let destroyAnim = me.pool.pull ("tembokHancur", 0, -65);
                me.game.world.addChild(destroyAnim, 50);
                let animOnce = true;
                destroyAnim.setCurrentAnimation('1',()=>{
                    if(animOnce){
                        animOnce = false;
        ...
        if(this.spawnerEnemy.end && this.spawnerEnemy2.end && this.spawnerEnemy3.end && this.spawnerEnemy4.end && this.spawnerEnemyZ007.end){
