...
game.level.L4003 = me.Stage.extend({
	onResetEvent: function() {
        // Put user code here //
        
        //  End of user code  //
		me.levelDirector.loadLevel("L4003");
		this.var = {};
        // Put user code here //
        ...
        let shakeBackground = me.pool.pull("me.Sprite", me.game.world.width, me.game.world.height, {
            ...
            region: "L4003_inside pyramid background"
        });
        ...
        this.spawnerEnemy3 = me.pool.pull ("spawnerEnemy", 150, -425,{level:currentLevel, container:this});
        this.spawnerEnemy4 = me.pool.pull ("spawnerEnemy", -150, -425,{level:currentLevel, container:this});
        ...
        let x = me.game.viewport.height/2 - me.game.world.height/2,
            y = x+201.25;
        let emitter = new me.ParticleEmitter(140, y, {
            image: image,
            width: 25,
            totalParticles: 200,
            angle: 1.55,
        ...
        let emitter2 = new me.ParticleEmitter(1012.5, y, {
            image: image,
            width: 25,
            totalParticles: 200,
            angle: 1.55,
        ...
        let batu1Shake = me.pool.pull("me.Sprite", me.game.world.width/2-250, me.game.viewport.height/2-selisihHeightLayar+10, {
                image: game.textureMap.get("africa"),
                region: "L4003_pilar 1"
            }),
            batu2Shake = me.pool.pull("me.Sprite", me.game.world.width/2-25, me.game.viewport.height/2-selisihHeightLayar-235, {
                image: game.textureMap.get("africa"),
                region: "L4003_pilar2"
            }),
            batu1 = me.pool.pull ("L4003_pilar1", -250, 10),
            batu2 = me.pool.pull ("L4003_pilar2", -25, -235),
            pasir = me.pool.pull ("africaPasir", -me.game.viewport.width, 0);
        me.game.world.addChild(batu1Shake, 5);
        me.game.world.addChild(batu2Shake, 5);
        me.game.world.addChild(batu1, 4);
        me.game.world.addChild(batu2, 4);
