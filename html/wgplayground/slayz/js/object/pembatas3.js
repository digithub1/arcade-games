...
game.object.pembatas3 = me.Sprite.extend({
	init: function(x, y, settings = {}){
		settings.texture = "eropa";
		settings.image = game.textureMap.get(settings.texture);
		var tempSprite = game.util.__populateAtlasIndices([
			"pembatas2"
		], settings);
		settings.framewidth = settings.framewidth || 320;
		settings.frameheight = settings.frameheight || 182;
		...
		this.body.addShape( me.pool.pull("me.Rect", 139, 75, 181, 43) );
		this.body.addShape( me.pool.pull("me.Polygon", 0, 0, [me.pool.pull("me.Vector2d", 72, 19), me.pool.pull("me.Vector2d", 143, 74), me.pool.pull("me.Vector2d", 140, 119), me.pool.pull("me.Vector2d", 66, 57), ]) );
		this.body.addShape( me.pool.pull("me.Rect", 8, 20, 69, 40) );
        ...
        this.body.getShape().translate(-this.width/2, -this.height/3);
