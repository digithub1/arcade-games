...
game.object.L5004_TiangKanan = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 227;
		settings.frameheight = settings.frameheight || 312;
		...
		this.body.addShape( me.pool.pull("me.Rect", 55, 30, 30, 98) );
