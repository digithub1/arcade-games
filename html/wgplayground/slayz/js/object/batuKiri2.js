...
game.object.batuKiri2 = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 291;
		settings.frameheight = settings.frameheight || 109;
		...
		this.body.addShape( me.pool.pull("me.Rect", 20, 64, 251, 45) );
        ...
        this.body.getShape().translate(-this.width/3, -this.height/3);
