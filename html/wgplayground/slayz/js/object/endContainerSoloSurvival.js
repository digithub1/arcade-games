...
game.object.endContainerSoloSurvival = me.Container.extend({
	init: function(x, y, settings = {}){
        ...
        this.continue = me.pool.pull("continueSoloSurvival", 95, 200);
        this.retry = me.pool.pull("retrySoloSurvival", -50, 217.5, {level:this.level});
