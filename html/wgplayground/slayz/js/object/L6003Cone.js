...
game.object.L6003Cone = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 75;
		settings.frameheight = settings.frameheight || 65;
		...
		this.body.addShape( me.pool.pull("me.Polygon", 0, 0, [me.pool.pull("me.Vector2d", 8, 57), me.pool.pull("me.Vector2d", 13, 30), me.pool.pull("me.Vector2d", 60, 17), me.pool.pull("me.Vector2d", 69, 40), ]) );
