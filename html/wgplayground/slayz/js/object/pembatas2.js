...
game.object.pembatas2 = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 74, 125, 42) );
		this.body.addShape( me.pool.pull("me.Polygon", 0, 0, [me.pool.pull("me.Vector2d", 123, 74), me.pool.pull("me.Vector2d", 192, 19), me.pool.pull("me.Vector2d", 203, 52), me.pool.pull("me.Vector2d", 125, 117), ]) );
		this.body.addShape( me.pool.pull("me.Rect", 191, 18, 71, 35) );
        ...
        this.body.getShape().translate(-this.width/3, -this.height/2);
