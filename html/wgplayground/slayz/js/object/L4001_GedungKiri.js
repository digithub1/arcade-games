...
game.object.L4001_GedungKiri = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 321;
		settings.frameheight = settings.frameheight || 279;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 321, 279) );
