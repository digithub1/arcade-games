...
game.object.L1003Batu3 = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 211;
		settings.frameheight = settings.frameheight || 189;
		...
		this.body.addShape( me.pool.pull("me.Rect", 50, 0, 321, 328) );
