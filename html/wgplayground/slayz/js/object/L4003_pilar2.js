...
game.object.L4003_pilar2 = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 171;
		settings.frameheight = settings.frameheight || 69;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 171, 69) );
