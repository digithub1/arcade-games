...
game.object.L4005_pilarBwhKanan = me.Sprite.extend({
	init: function(x, y, settings = {}){
		settings.texture = "africa";
		settings.image = game.textureMap.get(settings.texture);
		var tempSprite = game.util.__populateAtlasIndices([
			"L4005_pilar kanan bawah"
		], settings);
		settings.framewidth = settings.framewidth || 85;
		settings.frameheight = settings.frameheight || 184;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 85, 184) );
