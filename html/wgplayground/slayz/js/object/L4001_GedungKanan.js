...
game.object.L4001_GedungKanan = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 312;
		settings.frameheight = settings.frameheight || 233;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 312, 233) );
