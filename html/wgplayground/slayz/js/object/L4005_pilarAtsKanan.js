...
game.object.L4005_pilarAtsKanan = me.Sprite.extend({
	init: function(x, y, settings = {}){
		settings.texture = "africa";
		settings.image = game.textureMap.get(settings.texture);
		var tempSprite = game.util.__populateAtlasIndices([
			"L4005_pilar atas kanan"
		], settings);
		settings.framewidth = settings.framewidth || 183;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 183, 68) );
