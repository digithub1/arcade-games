...
game.object.L4002_batu = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 178;
		settings.frameheight = settings.frameheight || 93;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 17, 136, 76) );
