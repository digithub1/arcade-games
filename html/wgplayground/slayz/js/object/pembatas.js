...
game.object.pembatas = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 342;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 342, 132) );
		...
		this.body.getShape().translate(-this.width / 2.5, -this.height/3);
