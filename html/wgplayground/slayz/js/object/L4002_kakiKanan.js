...
game.object.L4002_kakiKanan = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 256;
		settings.frameheight = settings.frameheight || 277;
		...
		this.body.addShape( me.pool.pull("me.Rect", 47, 0, 209, 209) );
