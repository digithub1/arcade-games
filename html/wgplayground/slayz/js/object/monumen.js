...
game.object.monumen = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 154;
		settings.frameheight = settings.frameheight || 193;
		...
		this.body.addShape( me.pool.pull("me.Rect", 33, 0, 93, 144) );
