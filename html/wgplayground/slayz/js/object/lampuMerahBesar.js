...
game.object.lampuMerahBesar = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 281;
		settings.frameheight = settings.frameheight || 247;
		...
		this.body.addShape( me.pool.pull("me.Rect", 491, 0, 70, 493) );
		...
		this.body.getShape().translate(-this.width/2+25, -25);
