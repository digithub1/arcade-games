...
game.object.atapKanan = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 307;
		settings.frameheight = settings.frameheight || 40;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 307, 40) );
