...
game.object.Z029coffin = me.Sprite.extend({
	init: function(x, y, settings = {}){
		settings.texture = "africaZombie";
		settings.image = game.textureMap.get(settings.texture);
		var tempSprite = game.util.__populateAtlasIndices([
			"Z029_front_attack_0","Z029_front_attack_1","Z029_front_attack_2",
			"Z029_front_attack_3","Z029_front_walk_0","Z029_front_walk_1",
			"Z029_side_attack_0","Z029_side_attack_1","Z029_side_attack_2",
			"Z029_side_attack_3","Z029_side_walk_0","Z029_side_walk_1",
			"Z029_side_walk_2","Z029_side_walk_3"
		], settings);
		settings.framewidth = settings.framewidth || 50;
		settings.frameheight = settings.frameheight || 80;
		...
		this.addAnimation('front-walk', [{ name: "Z029_front_walk_0", delay: 100 },{ name: "Z029_front_walk_1", delay: 100 }]);
		this.addAnimation('front-attack', [{ name: "Z029_front_attack_0", delay: 75 },{ name: "Z029_front_attack_1", delay: 75 },{ name: "Z029_front_attack_2", delay: 75 },{ name: "Z029_front_attack_3", delay: 75 }]);
		this.addAnimation('side-walk', [{ name: "Z029_side_walk_0", delay: 100 },{ name: "Z029_side_walk_1", delay: 100 },{ name: "Z029_side_walk_2", delay: 100 },{ name: "Z029_side_walk_3", delay: 100 }]);
		this.addAnimation('side-attack', [{ name: "Z029_side_attack_0", delay: 75 },{ name: "Z029_side_attack_1", delay: 75 },{ name: "Z029_side_attack_2", delay: 75 },{ name: "Z029_side_attack_3", delay: 75 }]);
		this.setCurrentAnimation('front-walk');
		this.isKinematic = false;

		this.body = new me.Body(this);
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 50, 62) );
        ...
        // Put user code here //
        let scaleData = [0.9,1],
            random = Math.floor(Math.random()*scaleData.length);
        game.util.scale(this, scaleData[random]);
        ...
        this.attackSfx = "sfx-zombie-atk-1";
        this.type ="short";
		this.attack = true;
        this.walk = true;
        this.hitLimit = true;
	...
	onDeactivateEvent : function() {
        ...
        me.timer.clearTimeout(this.timeOt10);
        me.timer.clearTimeout(this.timeOt11);
        ...
        this.intervalDieFunc = me.timer.setInterval(()=>{
            ...
            if(this.animHit){
                if(this.pos == undefined){
                    ...
                    this.timeOt10 = me.timer.setTimeout(() => {
            ...
            if(this.health <= 0){
                ...
                if(this.die){
                    ...
                    if(this.peluru){
                        ...
                        this.timeOt11 = me.timer.setTimeout(()=>{
                            if(this.pos == undefined){
