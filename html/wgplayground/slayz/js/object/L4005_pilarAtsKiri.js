...
game.object.L4005_pilarAtsKiri = me.Sprite.extend({
	init: function(x, y, settings = {}){
		settings.texture = "africa";
		settings.image = game.textureMap.get(settings.texture);
		var tempSprite = game.util.__populateAtlasIndices([
			"L4005_pilar atas kiri"
		], settings);
		settings.framewidth = settings.framewidth || 198;
		settings.frameheight = settings.frameheight || 128;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 198, 74) );
