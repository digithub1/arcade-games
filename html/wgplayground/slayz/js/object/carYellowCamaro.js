...
game.object.carYellowCamaro = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 197;
		settings.frameheight = settings.frameheight || 178;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 46, 393, 261) );
        ...
        this.lampTween = me.pool.pull("carLights", x+130, y-110);
        me.game.world.addChild(this.lampTween, this.pos.z+1);
        game.util.rotate(this.lampTween, 10, 11, 0, 0);
        
        let shadow = me.pool.pull("carYellowShadow", x-20, y-22.5);
