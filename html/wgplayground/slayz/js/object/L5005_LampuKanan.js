...
game.object.L5005_LampuKanan = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 310;
		settings.frameheight = settings.frameheight || 179;
		...
		this.body.addShape( me.pool.pull("me.Rect", 63, 11, 18, 110) );
		this.body.addShape( me.pool.pull("me.Rect", 67, 11, 243, 5) );
        ...
        let lampu = me.pool.pull("L5003_cahayaLampu", this.pos.x-108, this.pos.y+18);
