...
game.object.L1004Lampu = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 128;
		settings.frameheight = settings.frameheight || 155;
		...
		this.body.addShape( me.pool.pull("me.Rect", 36, 7, 55, 148) );
        ...
        this.lampTween = me.pool.pull("L1004CahayaLampu", x+142.5, y+25);
    ...
    // Put user code here //
    tween: function(){
        this.tweenMove = new me.Tween(this.lampTween)
            .to({alpha:0.2}, 1000)
            .yoyo(true)
            .repeat(Infinity);
