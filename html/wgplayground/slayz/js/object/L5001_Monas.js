...
game.object.L5001_Monas = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 163;
		settings.frameheight = settings.frameheight || 163;
		...
		this.body.addShape( me.pool.pull("me.Rect", 57, 0, 106, 70) );
