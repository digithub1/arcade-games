...
game.object.carPoliceEropa = me.Sprite.extend({
	init: function(x, y, settings = {}){
		settings.texture = "southAmerica";
		...
		this.body.getShape().translate(-this.width/3, -this.height/4);
        this.sfx = ["sfx-bullet-impact-1","sfx-bullet-impact-2","sfx-bullet-impact-3"];
        
        let smoke = me.pool.pull("L2001PoliceCarSmoke", this.pos.x-75, this.pos.y-55);
        me.game.world.addChild(smoke, this.pos.z+1);
        //  End of user code  //
	},
