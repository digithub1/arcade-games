...
game.object.L5003_GedungKiri = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 532;
		settings.frameheight = settings.frameheight || 207;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 469, 92) );
