...
game.object.L4002_kepala = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 228;
		settings.frameheight = settings.frameheight || 246;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 182, 188) );
