...
game.object.lampuMerahKecil = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 61;
		settings.frameheight = settings.frameheight || 121;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 128, 107, 113) );
