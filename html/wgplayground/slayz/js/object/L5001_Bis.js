...
game.object.L5001_Bis = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 201;
		settings.frameheight = settings.frameheight || 239;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 201, 239) );
