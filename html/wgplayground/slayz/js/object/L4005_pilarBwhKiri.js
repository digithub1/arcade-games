...
game.object.L4005_pilarBwhKiri = me.Sprite.extend({
	init: function(x, y, settings = {}){
		settings.texture = "africa";
		settings.image = game.textureMap.get(settings.texture);
		var tempSprite = game.util.__populateAtlasIndices([
			"L4005_pilar kiri bawah"
		], settings);
		settings.framewidth = settings.framewidth || 85;
		settings.frameheight = settings.frameheight || 213;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 85, 213) );
