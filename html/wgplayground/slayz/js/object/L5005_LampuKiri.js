...
game.object.L5005_LampuKiri = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 303;
		settings.frameheight = settings.frameheight || 174;
		...
		this.body.addShape( me.pool.pull("me.Rect", 210, 11, 19, 111) );
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 245, 27) );
