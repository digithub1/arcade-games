...
game.object.L5002_TembokCol = me.Sprite.extend({
	init: function(x, y, settings = {}){
		settings.texture = "DailyReward";
		settings.image = game.textureMap.get(settings.texture);
		var tempSprite = game.util.__populateAtlasIndices([
			"black"
		], settings);
		settings.framewidth = settings.framewidth || 1170;
		settings.frameheight = settings.frameheight || 540;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 1170, 540) );
