...
game.object.L4002_kakiKiri = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 172;
		settings.frameheight = settings.frameheight || 255;
		...
		this.body.addShape( me.pool.pull("me.Rect", 0, 0, 131, 188) );
