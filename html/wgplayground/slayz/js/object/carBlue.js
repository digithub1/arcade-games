...
game.object.carBlue = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.frameheight = settings.frameheight || 143;
		...
		this.body.addShape( me.pool.pull("me.Polygon", 0, 0, [me.pool.pull("me.Vector2d", 45, 137), me.pool.pull("me.Vector2d", 0, 59), me.pool.pull("me.Vector2d", 150, 0), me.pool.pull("me.Vector2d", 181, 73), ]) );
        ...
        let shadow = me.pool.pull("carBlueShadow", x-10, y-15);
