...
game.object.LibraryDragAreaText = me.Sprite.extend({
    ...
    dragMove: function (e) {
        if (this.dragging === true) {
            ...
            if(this.container.textDesc.pos.y + moveY > this.container.limitBawah){
                moveY = this.container.limitBawah - this.container.textDesc.pos.y;
            }
            else if(this.container.textDesc.pos.y + moveY < this.container.limitAtas){
                moveY = this.container.limitAtas - this.container.textDesc.pos.y;
            }
                
            this.container.textDesc.pos.y += moveY;
        }
    },
