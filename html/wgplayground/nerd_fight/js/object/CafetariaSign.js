...
game.object.CafetariaSign = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.frameheight = settings.frameheight || 225;
		...
		this.addAnimation('idle', [{ name: "cafetaria_signer", delay: 100 }]);
