...
game.object.LibraryDragArea = me.Sprite.extend({
    ...
    dragMove: function (e) {
        if (this.dragging === true) {
            ...
            this.touchPosX = e.gameX;
            let length = this.container.bookList.length - 1;
            if(this.container.bookList[0].pos.x + moveX > this.container.limitKanan){
                moveX = this.container.limitKanan - this.container.bookList[0].pos.x;
            }
                
            if(this.container.bookList[length].pos.x + moveX < this.container.limitKiri){
                moveX = this.container.limitKiri - this.container.bookList[length].pos.x;
            }
                
            for(let i in this.container.bookList){
                this.container.bookList[i].pos.x += moveX;
            }
        }
    },
