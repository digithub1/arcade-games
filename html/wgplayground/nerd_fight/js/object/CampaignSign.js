...
game.object.CampaignSign = me.Sprite.extend({
	init: function(x, y, settings = {}){
		settings.texture = "Door";
		settings.image = game.textureMap.get(settings.texture);
		var tempSprite = game.util.__populateAtlasIndices([
			"campaign plank_signer"
		], settings);
		settings.framewidth = settings.framewidth || 727;
		settings.frameheight = settings.frameheight || 382;
