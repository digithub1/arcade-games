...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "Princess Halloween Makeup HalfFaces Tutorial";
	...
	*/
	function _onFinishAnimatedCartoonScreenFunc(event)
	{
		...
		*/
		...
		createjs.Tween.get(currentScreen_mc.next_btn).wait(0).to({alpha:1}, _DELAY * 1000);
	...
	*/
	...
	{
		var currentTarget_mc = event.currentTarget;
		new Edapskov_Glow(currentTarget_mc, _DELAY / 5, "rgba(255, 255, 255, 0.3)", 15);
	}
	...
	*/
	...
	{
		var current_mc = event.currentTarget;
		createjs.Tween.get(current_mc).wait(0).to({scaleX:1.1, scaleY:1.1}, (_DELAY / 5) * 1000);
	}
	...
	*/
	function _updateIndicatorCleanupActionFunc()
	{
		...
		*/
		...
		createjs.Tween.get(cleanup_mc.panel_mc.indicator_mc.indicator_mc).wait(_DELAY * 1000).to({scaleX:share_num}, (_DELAY / 4) * 1000);
	}
	...
	*/
	...
	function _onClickObjectMcQuizActionFunc(event)
	{
		...
		*/
		...
		_before.addChild(gravityExplosion_mc);
		gravityExplosion_mc.gotoAndStop(0);
		point_obj = current_mc.localToLocal(event.localX, event.localY, _before);
		gravityExplosion_mc.x = point_obj.x;
		gravityExplosion_mc.y = point_obj.y;
		/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1602782620" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=2409" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
