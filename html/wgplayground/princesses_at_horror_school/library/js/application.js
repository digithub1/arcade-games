...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "Princesses at Horror School";
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					...
					jacket_0:{rewarded:false},
					jacket_1:{rewarded:false},
					jacket_2:{rewarded:false},
					jacket_3:{rewarded:false},
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1726852687" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
