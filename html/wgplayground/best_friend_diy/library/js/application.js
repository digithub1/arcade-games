...
function Application()
{
	...
	*/
	...
	var _information = {
		...
		ingredients:
		{
			...
			ingredient_9:{product:null},
			ingredient_10:{product:null},
			ingredient_11:{product:null},
			ingredient_12:{product:null},
			ingredient_13:{product:"product_5"},
			ingredient_14:{product:"product_1"},
			ingredient_15:{product:"product_3"},
			ingredient_16:{product:"product_2"},
			ingredient_17:{product:null},
			ingredient_18:{product:"product_4"},
			ingredient_19:{product:null},
			ingredient_20:{product:"product_6"},
			ingredient_21:{product:null},
			ingredient_22:{product:null},
			ingredient_23:{product:null}
		},
		lastFoundProduct:null,
		products:
		{
			product_1:{ingredients:[1, 2, 3], completed:null},
			product_2:{ingredients:[4, 5, 6], completed:null},
			product_3:{ingredients:[10, 11, 12], completed:null},
			product_4:{ingredients:[14, 17, 19], completed:null},
			product_5:{ingredients:[7, 8, 9], completed:null},
			product_6:{ingredients:[13, 15, 16], completed:null},
			product_7:{ingredients:[18, 20, 21], completed:null}
		},
		fails:
		{
			totalFails:["fail_1", "fail_2", "fail_3"],
			currentFail:null
		}
	};
	/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1655919910" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
