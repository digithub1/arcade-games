...
function Application()
{
	...
	var _information = {
		...
		locations:{
			location_1:{
				...
				totalRounds:null,
				rounds:{
					round_1:{timer:30, completed:null},
					round_2:{timer:60, completed:null},
					round_3:{timer:90, completed:null},
					round_4:{timer:120, completed:null}
				}
			},
			location_2:{
				completed:null,
	...
	*/
	function _beginGameFunc()
	{
		...
		*/
		var cards_mc = currentScreen_mc.cards_mc;
		...
		*/
		currentScreen_mc.indicator_mc.gotoAndStop(0);
		currentScreen_mc.indicator_mc.body_mc.gotoAndStop(0);
		currentScreen_mc.indicator_mc.body_mc.gotoAndStop(Number(currentScreen_mc.indicator_mc.body_mc.totalFrames - 1));
		/*
		
		*/
		currentScreen_mc.preview_mc.gotoAndStop(0);
		_updateHeroesFunc(currentScreen_mc.preview_mc);
		currentScreen_mc.preview_mc.play();
		/*
	...
	*/
	function _startRoundFunc()
	{
		...
		*/
		...
		_information.counter = _information.timer;
		...
		*/
		...
		_information.timeout_id = setTimeout(_onTickCountDownFunc, 1000);
	}
	/*
	
	*/
	function _onTickCountDownFunc()
	{
		/*
		
		*/
		_soundManager.addSoundFunc("tick_sound", 0, 0, 0, 0.01, 0);
		/*
		...
		*/
		...
		currentScreen_mc.popup_mc.countdown_mc.gotoAndStop(_information.countDown_uint);
		_information.countDown_uint--;
		if(_information.countDown_uint < 0)
		{
			if(_information.timeout_id != null)
			{
				clearTimeout(_information.timeout_id);
			...
			_information.timeout_id = setTimeout(_showCardsFunc, 1000);
		}
		else
		{
			if(_information.timeout_id != null)
	...
	*/
	function _showCardsFunc()
	{
		...
		while(i < totalCards_num)
		{
			...
			*/
			if(cards_mc.getChildAt(i))
			{
				...
				timelineControl_obj.gotoFunc("begin", 1, 0);
			}
			/*
		...
		*/
		...
		_information.timeout_id = setTimeout(_hideCardsFunc, 2000);
	}
	/*
	...
	*/
	function _hideCardsFunc()
	{
		...
		while(i < totalCards_num)
		{
			...
			*/
			if(cards_mc.getChildAt(i))
			{
				...
				card_mc = card_mc["body_" + currentCard_num + "_mc"];
				timelineControl_obj = new Edapskov_TimelineControl(card_mc);
				timelineControl_obj.gotoFunc("end", 1, 0);
			}
			/*
		...
		*/
		...
		_information.timeout_id = setTimeout(_activeCardsFunc, 500);
	}
	/*
	...
	*/
	function _activeCardsFunc()
	{
		...
		*/
		currentScreen_mc.cards_mc.mouseChildren = true;
		currentScreen_mc.cards_mc.mouseEnabled = true;
		/*
		...
		*/
		...
		_information.interval_id = setInterval(_onTickIndicatorFunc, 1000);
	}
	/*
	...
	*/
	function _givePrizeFunc()
	{
		...
		*/
		_soundManager.addSoundFunc("bonus_sound", 0, 0, 0, 0.4, 0);
		/*
		
		*/
		var currentScreen_mc = _main.getChildAt(0);
		currentScreen_mc.popup_mc.visible = true;
		currentScreen_mc.popup_mc.gotoAndStop(2);
		currentScreen_mc.popup_mc.prize_mc.gotoAndStop(0);
		currentScreen_mc.popup_mc.prize_mc.body_mc.gotoAndStop(0);
		currentScreen_mc.popup_mc.prize_mc.body_mc.gotoAndStop(_information.currentNameLocation + "_" + _information.locations[_information.currentNameLocation].currentNameRound);
		var timelineControl_obj = new Edapskov_TimelineControl(currentScreen_mc.popup_mc.prize_mc);
		timelineControl_obj.gotoFunc("end", 1, 0);
	...
	*/
	function _onFinishGivePrizeFunc(event)
	{
		...
		*/
		_soundManager.addSoundFunc("magic_2_sound", 0, 0, 0, 0.4, 0);
		/*
	...
	*/
	function _completedRoundFunc()
	{
		...
		*/
		if(currentScreen_mc.preview_mc[_information.currentNameLocation])
		{
			object_mc = currentScreen_mc.preview_mc[_information.currentNameLocation];
		...
		*/
		...
		{
			currentScreen_mc.popup_mc.gotoAndStop(3);
			currentScreen_mc.popup_mc.mouseEnabled = true;
			currentScreen_mc.popup_mc.mouseChildren = false;
			currentScreen_mc.popup_mc.cursor = "pointer";
			currentScreen_mc.popup_mc.addEventListener("click", _onClickStartRoundFunc, false);
	...
	*/
	function _onTickIndicatorFunc()
	{
		...
		*/
		...
		{
			currentScreen_mc.indicator_mc.body_mc.gotoAndStop(Math.floor((_information.counter * currentScreen_mc.indicator_mc.body_mc.totalFrames) / _information.timer));
		}
		else
		{
			/*
			...
			*/
			currentScreen_mc.cards_mc.mouseChildren = false;
			currentScreen_mc.cards_mc.mouseEnabled = false;
			/*
			
			*/
			_animationTransitionBetweenScenesFunc(_lossFunc, 1, 1, null, true);
		}
	}
	/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1644512126" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	function _lossFunc()
	{
		...
		*/
		_soundManager.addSoundFunc("loss_sound", 0, 0, 0, 0.3, 0);
		/*
		...
		*/
		...
		{
			currentScreen_mc.moreGames_btn.alpha = 0.01;
			createjs.Tween.get(currentScreen_mc.moreGames_btn).wait((_DELAY * 0.5) * 1000).to({alpha:1}, _DELAY * 1000, createjs.Ease.cubicInOut);
			currentScreen_mc.moreGames_btn.addEventListener("click", _onClickMoreGamesBtnFunc, false);
		}
		/*
		...
		*/
		if(currentScreen_mc.freeGames_mc)
		{
			...
			createjs.Tween.get(currentScreen_mc.freeGames_mc).wait((_DELAY * 1.5) * 1000).to({alpha:1}, _DELAY * 1000, createjs.Ease.cubicInOut);
			currentScreen_mc.freeGames_mc.addEventListener("click", _onClickFreeGamesMcFunc, false);
		}
		/*
		...
		*/
		...
		createjs.Tween.get(currentScreen_mc.playAgain_btn).wait((_DELAY * 1.5) * 1000).to({alpha:1}, _DELAY * 1000, createjs.Ease.cubicInOut);
	...
	*/
	function _winFunc()
	{
		...
		*/
		_soundManager.addSoundFunc("win_sound", 0, 0, 0, 0.3, 0);
		/*
		...
		*/
		if(currentScreen_mc.facebook_btn)
		{
			...
			createjs.Tween.get(currentScreen_mc.facebook_btn).wait(0).to({alpha:1}, _DELAY * 1000, createjs.Ease.cubicInOut);
		...
		*/
		if(currentScreen_mc.banner_1_mc)
		{
			...
			createjs.Tween.get(currentScreen_mc.banner_1_mc).wait((_DELAY * 1.0) * 1000).to({alpha:1}, _DELAY * 1000, createjs.Ease.cubicInOut);
		...
		if(currentScreen_mc.banner_2_mc)
		{
			...
			createjs.Tween.get(currentScreen_mc.banner_2_mc).wait((_DELAY * 1.0) * 1000).to({alpha:1}, _DELAY * 1000, createjs.Ease.cubicInOut);
		...
		*/
		if(currentScreen_mc.photo_btn)
		{
			...
			createjs.Tween.get(currentScreen_mc.photo_btn).wait((_DELAY * 1.0) * 1000).to({alpha:1}, _DELAY * 1000, createjs.Ease.cubicInOut);
		...
		*/
		if(currentScreen_mc.photoContainer_mc)
		{
			...
			*/
			if(currentScreen_mc.photoContainer_mc.heroes_mc)
			{
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3185" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
	function _onClickBannerMcFunc_2(event)
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3169" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
