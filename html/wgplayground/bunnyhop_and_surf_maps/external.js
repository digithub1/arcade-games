...
function SetScore(leadId,score,variant){
	if(window.lb != null) window.lb.setLeaderboardScore(leadId, parseInt(score));
    if(window.ndk == null){
...
function SetScoreDelay(leadId,score,variant,msDelay){
	setTimeout(function(){
		SetScore(leadId,score,variant);
	},msDelay);
}
...
function showleads(LeadID, variant, withMe){
