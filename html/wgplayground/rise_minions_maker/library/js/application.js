...
function Application()
{
		...
		heroes:{
			hero_1:{
				...
				dress:{
					...
					makeup:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					hair:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					shirt:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					pants:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					socks:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					shoes:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1657210355" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3425" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
