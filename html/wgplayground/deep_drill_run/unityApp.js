const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/DeepMiner[29]-mirraSDK[5.1.20].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/DeepMiner[29]-mirraSDK[5.1.20].data.unityweb",
            frameworkUrl: buildUrl + "/DeepMiner[29]-mirraSDK[5.1.20].framework.js.unityweb",
            codeUrl: buildUrl + "/DeepMiner[29]-mirraSDK[5.1.20].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "Mindillusion",
            productName: "DeepMiner",
        ...
        const devicePixelRatioSetting = "";
        const devicePixelRatio = this.toNumber(devicePixelRatioSetting);
        console.log("devicePixelRatio", devicePixelRatioSetting, devicePixelRatio);
        if (!this.isEmpty(devicePixelRatioSetting) && this.isNumber(devicePixelRatio) && devicePixelRatio > 0) {
