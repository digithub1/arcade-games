/*
* @author edapskov
* @copyright 2019 edapskov v 6.01
*/
function Application()
{
	...
	*/
	this.copyright = "© DL-Studio, v 6.01";
	/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1674061506" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	function _resultFunc()
	{
		...
		*/
		if(currentScreen_mc.vk_btn)
		{
			currentScreen_mc.vk_btn.addEventListener("click", _onClickVkBtnFunc, false);
		}
		/*
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3654" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
	...
	function _onClickVkBtnFunc(event)
	{
