/*
* @author edapskov
* @copyright 2019 edapskov v 8.003
*/
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Easter Rabbit Style";
	...
	*/
	this.copyright = "© DL-Studio, v 8.003";
	/*
			...
			if(_action_mc.body_mc)
			{
				...
				*/
				...
				if(_action_mc.body_mc.getChildByName("trackMoveContainer"))
				{
					...
					else if(_information.trackMove == 2 || _information.trackMove == 3)
					{
				...
				*/
				if(_action_mc.panel_mc)
				{
					...
					*/
					...
					createjs.Tween.get(_action_mc.panel_mc).wait(_DELAY * 1000).to({alpha:1}, _DELAY * 1000);
				}
			}
			else
			{
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1677602836" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
