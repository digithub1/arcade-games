...
// removed the container clone:
//!!!        var clonedTop = parseInt($last.css('top')) - 100;
//!!!        var $clone = $last.clone().insertAfter($last).css('top', clonedTop + '%');

        var $iframe =
            $('<iframe style="position:relative; width:100%; height: 100%; max-width: 100%; border-style:none; display:none; pointer-events:auto;"></iframe>')
