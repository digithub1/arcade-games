const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/DashOrDie[3]-mirraSDK[5.1.20].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/DashOrDie[3]-mirraSDK[5.1.20].data.unityweb",
            frameworkUrl: buildUrl + "/DashOrDie[3]-mirraSDK[5.1.20].framework.js.unityweb",
            codeUrl: buildUrl + "/DashOrDie[3]-mirraSDK[5.1.20].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "Booma Top",
            productName: "Dash Or Die",
            productVersion: "0.0.82",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
                        console.error(msg);
        ...
        const matchWebGLToCanvasSize = "true";
