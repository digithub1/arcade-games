...
function Application()
{
	...
	*/
	this.copyright = "© DL-Studio, v 3.1";
	/*
	...
	*/
	function _onClickPlayBtnFunc(event)
	{
		...
		*/
		currentTarget_mc.removeEventListener("click", _onClickPlayBtnFunc, false);
		/*
	...
	function _selectFunc()
	{
		...
		*/
		if(currentScreen_mc.moreGames_btn)
		{
			...
			createjs.Tween.get(currentScreen_mc.moreGames_btn).wait((_DELAY * 1) * 1000).to({alpha:1}, (_DELAY * 1) * 1000);
			currentScreen_mc.moreGames_btn.addEventListener("click", _onClickMoreGamesBtnFunc, false);
		}
		/*
	...
	function _updateSelectionLocationFunc()
	{
		...
		*/
		for(var propLocations in _information.locations)
		{
			if(_information.locations.hasOwnProperty(propLocations))
			{
				if(currentScreen_mc.locations_mc[propLocations])
				{
					location_mc = currentScreen_mc.locations_mc[propLocations];
	...
	*/
	function _locationFunc()
	{
		...
		*/
		...
		currentScreen_mc.panel_mc.bar_mc.gotoAndStop(0);
		currentScreen_mc.panel_mc.bar_mc.mouseEnabled = true;
		currentScreen_mc.panel_mc.bar_mc.mouseChildren = true;
		currentScreen_mc.panel_mc.bar_mc.cursor = "move";
		currentScreen_mc.panel_mc.bar_mc.addEventListener("pressmove", _onPressMoveBarPanelMcFunc, false);
		currentScreen_mc.panel_mc.bar_mc.addEventListener("pressup", _onPressUpBarPanelMcFunc, false);
		_colouringFunc(currentScreen_mc.panel_mc.bar_mc.color_swatch_mc, _information.currentColor);
		/*
		
		*/
		currentScreen_mc.panel_mc.back_btn.addEventListener("click", _onClickBackBtnPanelMcFunc, false);
		currentScreen_mc.panel_mc.photo_btn.addEventListener("click", _onClickPhotoBtnPanelMcFunc, false);
		currentScreen_mc.panel_mc.substrate_btn.addEventListener("click", _onClickSubstrateBtnPanelMcFunc, false);
		/*
		
		*/
		currentScreen_mc.panel_mc.color_picker_mc.mouseEnabled = true;
		currentScreen_mc.panel_mc.color_picker_mc.mouseChildren = true;
		currentScreen_mc.panel_mc.color_picker_mc.cursor = "crosshair";
		currentScreen_mc.panel_mc.color_picker_mc.addEventListener("click", _onClickColorPickerMcFunc, false);
		/*
		
		*/
		currentScreen_mc.photoContainer_mc.gotoAndStop(0);
		currentScreen_mc.photoContainer_mc.logotype_mc.visible = true;
		if(currentScreen_mc.photoContainer_mc.decorTop_mc)
		{
			currentScreen_mc.photoContainer_mc.decorTop_mc.gotoAndStop(0);
			currentScreen_mc.photoContainer_mc.decorTop_mc.mouseEnabled = false;
			currentScreen_mc.photoContainer_mc.decorTop_mc.mouseChildren = false;
		}
		if(currentScreen_mc.photoContainer_mc.decorBottom_mc)
		{
			currentScreen_mc.photoContainer_mc.decorBottom_mc.gotoAndStop(0);
			currentScreen_mc.photoContainer_mc.decorBottom_mc.mouseEnabled = false;
			currentScreen_mc.photoContainer_mc.decorBottom_mc.mouseChildren = false;
		}
		currentScreen_mc.photoContainer_mc.bg_mc.gotoAndStop(0);
		/*
		
		*/
		currentScreen_mc.photoContainer_mc.picture_mc.gotoAndStop(0);
		var totalParts_num = currentScreen_mc.photoContainer_mc.picture_mc.numChildren;
		var i = 0;
		var part_mc;
		_information.locations[_information.currentNameLocation].arrayParts = new Array();
		while(i < totalParts_num)
		{
			/*
			
			*/
			part_mc = currentScreen_mc.photoContainer_mc.picture_mc.getChildAt(i);
			/*
			...
			*/
			if(part_mc.totalFrames)
			{
				...
				*/
				...
				part_mc.name = "part_" + i;
				part_mc.cursor = "crosshair";
				part_mc.mouseChildren = false;
				part_mc.mouseEnabled = true;
				part_mc.addEventListener("click", _onClickPartMcFunc, false);
				/*
				
				*/
				_information.locations[_information.currentNameLocation].arrayParts[i] = new Array();
				_information.locations[_information.currentNameLocation].arrayParts[i][0] = null;
			}
			/*
	...
	*/
	function _onPressMoveBarPanelMcFunc(event)
	{
		/*
		...
		*/
		if((_information.correctionDragX_num == null) && (_information.correctionDragY_num == null))
		{
			_information.correctionDragX_num = event.localX;
			_information.correctionDragY_num = event.localY;
		}
		/*
		
		*/
		var point_obj = panel_mc.localToLocal(event.localX, event.localY, currentScreen_mc);
		panel_mc.x = point_obj.x - _information.correctionDragX_num;
		panel_mc.y = point_obj.y - _information.correctionDragY_num;
	}
	function _onPressUpBarPanelMcFunc(event)
	{
		_information.correctionDragX_num = null;
		_information.correctionDragY_num = null;
	}
	/*
	
	*/
	function _onClickBackBtnPanelMcFunc(event)
	{
		/*
		...
		*/
		currentTarget_mc.removeEventListener("click", _onClickBackBtnPanelMcFunc, false);
		/*
	...
	*/
	function _onClickPhotoBtnPanelMcFunc(event)
	{
		/*
		...
		*/
		...
		finally
		{
			...
			*/
			currentScreen_mc.photoContainer_mc.logotype_mc.visible = false;
	...
	function _createBackupPhotoFunc()
	{
		...
		*/
		var photoContainer_mc = new lib["photoContainer_" + String(_information.currentNameLocation.split("_")[1]) + "_mc"]();
		...
		*/
		if(photoContainer_mc.decorTop_mc)
		{
			photoContainer_mc.decorTop_mc.gotoAndStop(0);
		}
		/*
		
		*/
		if(photoContainer_mc.decorBottom_mc)
		{
			photoContainer_mc.decorBottom_mc.gotoAndStop(0);
		}
		/*
		
		*/
		if(photoContainer_mc.bg_mc)
		{
			photoContainer_mc.bg_mc.gotoAndStop(0);
			photoContainer_mc.bg_mc.gotoAndStop(currentScreen_mc.photoContainer_mc.bg_mc.currentFrame);
		}
		/*
		
		*/
		photoContainer_mc.picture_mc.gotoAndStop(0);
		var totalParts_num = photoContainer_mc.picture_mc.numChildren;
		var i = 0;
		var part_mc;
		while(i < totalParts_num)
		{
			...
			*/
			part_mc = photoContainer_mc.picture_mc.getChildAt(i);
			/*
			...
			*/
			if(part_mc.totalFrames)
			{
				...
				*/
				if(_information.locations[_information.currentNameLocation].arrayParts[i][0] != null)
				{
					_colouringFunc(part_mc, _information.locations[_information.currentNameLocation].arrayParts[i][0]);
				}
			}
			/*
		...
		*/
		photoContainer_mc.cache(0, 0, _CWIDTH, _CHEIGHT, 1.0);
	...
	*/
	function _onClickSubstrateBtnPanelMcFunc(event)
	{
		/*
		...
		*/
		var currentScreen_mc = _main.getChildAt(0);
		var bg_mc = currentScreen_mc.photoContainer_mc.bg_mc;
		var currentFrame_num = bg_mc.currentFrame;
		var totalFrames_num = bg_mc.totalFrames;
		/*
		
		*/
		if(currentFrame_num < (totalFrames_num - 1))
		{
			currentFrame_num++;
		}
		else
		...
		*/
		bg_mc.gotoAndStop(currentFrame_num);
	}
	/*
	
	*/
	function _onClickColorPickerMcFunc(event)
	{
		/*
		...
		*/
		_information.currentColor = bitmapdata_obj.getPixel(event.localX, event.localY);
		/*
	...
	*/
	function _onClickPartMcFunc(event)
	{
		/*
		
		*/
		var currentPart_mc = event.currentTarget;
		var index_num = parseInt(currentPart_mc.name.split("_")[1]);
		/*
		
		*/
		_colouringFunc(currentPart_mc, _information.currentColor);
		/*
		
		*/
		_information.locations[_information.currentNameLocation].arrayParts[index_num][0] = _information.currentColor;
	}
	/*
