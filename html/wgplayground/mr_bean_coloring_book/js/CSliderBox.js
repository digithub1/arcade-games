function CSliderBox(iXPos,iYPos,oSprite,oParentContainer){
    ...
    this.unload = function(){
       _oBoxContainer.off("mousedown", _oListenerMouseDown);
       _oBoxContainer.off("pressup" , _oListenerMouseUp); 
    ...
    this._initListener = function(){
       _oListenerMouseDown = _oBoxContainer.on("mousedown", this.buttonDown);
       _oListenerMouseUp = _oBoxContainer.on("pressup" , this.buttonRelease);      
    };
