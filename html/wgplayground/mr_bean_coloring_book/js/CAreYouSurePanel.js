function CAreYouSurePanel(){
    ...
    this._init = function(){
        ...
        _oMsg = new createjs.Text(""," 80px "+PRIMARY_FONT, "#724134");
        _oMsg.y = -160;
        ...
        _oButExit = new CGfxButton(-170, 150, oSprite, _oPanelContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this.hide, this);
        
        var oSprite = s_oSpriteLibrary.getSprite('but_yes');
        _oButConfirm = new CGfxButton(170, 150, oSprite, _oPanelContainer);
