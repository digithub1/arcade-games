...
export default class gamePlayPauseBtn extends me.Sprite {
	constructor(x, y, settings = {}) {
        ...
        this.addAnimation('0', [{ name: "button-next", delay: 1 }]);
        this.addAnimation('1', [{ name: "retry", delay: 1 }]);
        this.addAnimation('2', [{ name: "home", delay: 1 }]);
        ...
        if(this.click){
            ...
            me.timer.setTimeout(()=>{
                if(once){
                    ...
                    if(this.type == 0){
                        //resume
                        me.state.current().pauseOffFunc();
                    }else if(this.type == 1){
                        //restart
                        me.game.viewport.fadeIn("#000000", 1000,()=>{
                            me.state.change("tempRestartScene");
                        });
                    }else if(this.type == 2){
                        //ke menu
