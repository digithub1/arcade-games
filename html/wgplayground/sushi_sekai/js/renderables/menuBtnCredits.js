    ...
    onRelease(){
        if(this.click){
            ...
            me.timer.setTimeout(()=>{
                if(once){
                    once = false;
                    me.state.current().creditsBoard.tweenOnFunc(me.state.current().blackLayer);
                }
            }, 100);
            me.timer.setTimeout(()=>{
                this.click = true;
