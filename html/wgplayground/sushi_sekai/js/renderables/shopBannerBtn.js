...
export default class shopBannerBtn extends me.Sprite {
	constructor(x, y, settings = {}) {
        ...
        this.addAnimation('0', [{ name: "no", delay: 1 }]);
        this.addAnimation('1', [{ name: "yes", delay: 1 }]);
        ...
        if(this.click){
            ...
            me.timer.setTimeout(()=>{
                if(once){
                    once = false;
                    if(this.type == 0){
                        me.state.current().shopBannerOffFunc();
                        //sound
                            me.audio.play("sfx_button");
                        //--
                    }else{
                        me.state.current().shopBannerCalculateItem();
                        //sound
