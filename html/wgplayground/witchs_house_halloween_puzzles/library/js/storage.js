...
lib.ssMetadata = [
		...
		{name:"storage_atlas_4", frames: [[0,602,600,600],[0,0,800,600],[602,602,520,600]]},
		{name:"storage_atlas_5", frames: [[522,0,520,520],[542,522,500,500],[0,602,540,540],[0,0,520,600]]},
		{name:"storage_atlas_6", frames: [[0,1004,1200,200],[0,502,500,500],[502,0,500,500],[0,0,500,500],[502,502,440,440]]},
		{name:"storage_atlas_7", frames: [[794,684,500,300],[0,684,400,400],[0,282,400,400],[402,282,400,400],[402,684,390,390],[804,282,400,400],[0,0,640,280],[642,0,640,280]]},
		{name:"storage_atlas_8", frames: [[0,382,380,340],[342,734,300,300],[382,382,350,350],[734,684,340,340],[382,0,380,380],[0,0,380,380],[0,1006,256,256],[946,1026,300,200],[764,0,380,340],[764,342,380,340],[258,1036,300,200],[644,1026,300,200],[0,724,340,280]]},
		{name:"storage_atlas_9", frames: [[0,202,190,190],[302,0,200,300],[504,0,200,300],[174,1146,120,120],[1150,1136,120,120],[1100,192,190,190],[906,1136,120,120],[192,202,90,90],[1028,1136,120,120],[1076,384,180,180],[894,384,180,180],[296,1024,120,120],[0,1135,120,120],[540,1034,120,120],[662,1074,120,120],[284,643,48,48],[908,192,190,190],[903,648,140,140],[619,648,140,140],[142,643,140,140],[761,648,140,140],[752,392,140,140],[426,720,140,140],[1045,710,140,140],[284,720,140,140],[0,709,140,140],[0,567,140,140],[388,302,180,180],[570,392,180,180],[508,952,220,80],[752,566,340,80],[418,1034,120,120],[784,1136,120,120],[706,202,186,188],[142,567,40,55],[334,643,40,43],[284,202,10,11],[1218,1014,69,94],[570,302,100,73],[619,574,57,60],[296,1146,99,100],[672,335,23,38],[672,302,31,31],[678,574,50,50],[1258,384,40,147],[1094,566,150,142],[1246,566,50,210],[122,947,50,297],[192,302,194,178],[0,394,187,171],[377,484,187,132],[189,482,186,159],[1178,852,120,160],[264,862,120,160],[386,862,120,160],[0,851,120,160],[934,852,120,160],[568,790,120,160],[812,790,120,160],[142,785,120,160],[1056,852,120,160],[690,790,120,160],[908,0,190,190],[1100,0,190,190],[397,1156,80,80],[566,574,40,40],[1096,1014,120,120],[174,1024,120,120],[852,1014,120,120],[974,1014,120,120],[730,952,120,120],[0,1013,120,120],[377,618,240,100],[706,0,200,200],[0,0,300,200]]}
];
...
(lib.lock_0_mc = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-30,-28,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(-30,-28,90,90);
p.frameBounds = [rect];
...
(lib.frame_1_mc = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-83,-83,0.922,0.922);
...
(lib.body_title_result_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance = new lib.title_result_en_img();
	this.instance.setTransform(-260,-300);

	this.instance_1 = new lib.title_result_ru_img();
...
(lib.body_frame_0_mc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой 1
	this.instance = new lib.frame_0_img();
...
(lib.tip_puzzle_2_mc = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({alpha:1},5).to({x:260},20).to({alpha:0.012},5).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(-80,-80,160,160);
p.frameBounds = [rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, new cjs.Rectangle(-67,-80,160,160), new cjs.Rectangle(-54,-80,160,160), new cjs.Rectangle(-41,-80,160,160), new cjs.Rectangle(-28,-80,160,160), new cjs.Rectangle(-15,-80,160,160), new cjs.Rectangle(-2,-80,160,160), new cjs.Rectangle(11,-80,160,160), new cjs.Rectangle(24,-80,160,160), new cjs.Rectangle(37,-80,160,160), new cjs.Rectangle(50,-80,160,160), new cjs.Rectangle(63,-80,160,160), new cjs.Rectangle(76,-80,160,160), new cjs.Rectangle(89,-80,160,160), new cjs.Rectangle(102,-80,160,160), new cjs.Rectangle(115,-80,160,160), new cjs.Rectangle(128,-80,160,160), new cjs.Rectangle(141,-80,160,160), new cjs.Rectangle(154,-80,160,160), new cjs.Rectangle(167,-80,160,160), rect=new cjs.Rectangle(180,-80,160,160), rect, rect, rect, rect, rect];
...
(lib.panel_1_mc = function(mode,startPosition,loop) {
	...
	// tip
	this.instance = new lib.tip_puzzle_2_mc();
	this.instance.setTransform(-260,150);
...
(lib.frame_0_mc = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AoRLtQjcABABjcIAAwjQgBjcDcABIQjAAQDbgBAADcIAAQjQAADcjbgBgApaoRIAAQjQAABKBJgBIQjAAQBJABAAhKIAAwjQAAhJhJAAIwjAAQhJAAAABJg");
	...
	// graph
	this.instance_1 = new lib.body_frame_0_mc();
...
(lib.simple_timer_5_mc = function(mode,startPosition,loop) {
	...
	this.char_0.setTransform(40,0);

	this.char_1 = new lib.simple_timer_2_mc();
	this.char_1.setTransform(-40,0);
...
p.nominalBounds = rect = new cjs.Rectangle(-300,-80,600,160);
p.frameBounds = [rect];
...
(lib.mini_play_3_mc = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({scaleX:1,scaleY:1,x:-5},10).to({x:10},20).to({scaleX:0.83,scaleY:0.83,x:0},10).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(-50,-50,100,100);
p.frameBounds = [rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, new cjs.Rectangle(-51.4,-50.9,102,102), new cjs.Rectangle(-52.9,-51.9,104,104), new cjs.Rectangle(-54.4,-52.9,106,106), new cjs.Rectangle(-55.9,-53.9,108,108), new cjs.Rectangle(-57.4,-54.9,110,110), new cjs.Rectangle(-58.9,-55.9,112,112), new cjs.Rectangle(-60.4,-56.9,114,114), new cjs.Rectangle(-61.9,-57.9,116,116), new cjs.Rectangle(-63.4,-58.9,118,118), new cjs.Rectangle(-65,-60,120,120), new cjs.Rectangle(-64.2,-60,120,120), new cjs.Rectangle(-63.5,-60,120,120), new cjs.Rectangle(-62.7,-60,120,120), new cjs.Rectangle(-62,-60,120,120), new cjs.Rectangle(-61.2,-60,120,120), new cjs.Rectangle(-60.5,-60,120,120), new cjs.Rectangle(-59.7,-60,120,120), new cjs.Rectangle(-59,-60,120,120), new cjs.Rectangle(-58.2,-60,120,120), new cjs.Rectangle(-57.5,-60,120,120), new cjs.Rectangle(-56.7,-60,120,120), new cjs.Rectangle(-56,-60,120,120), new cjs.Rectangle(-55.2,-60,120,120), new cjs.Rectangle(-54.5,-60,120,120), new cjs.Rectangle(-53.7,-60,120,120), new cjs.Rectangle(-53,-60,120,120), new cjs.Rectangle(-52.2,-60,120,120), new cjs.Rectangle(-51.5,-60,120,120), new cjs.Rectangle(-50.7,-60,120,120), new cjs.Rectangle(-50,-60,120,120), new cjs.Rectangle(-50,-59,118,118), new cjs.Rectangle(-49.9,-57.9,116,116), new cjs.Rectangle(-49.9,-56.9,114,114), new cjs.Rectangle(-50,-56,112,112), new cjs.Rectangle(-50,-55,110,110), new cjs.Rectangle(-49.9,-53.9,108,108), new cjs.Rectangle(-49.9,-52.9,106,106), new cjs.Rectangle(-50,-52,104,104), new cjs.Rectangle(-49.9,-50.9,102,102), new cjs.Rectangle(-50,-50,100,100)];
...
(lib.photoContainer_mc = function(mode,startPosition,loop) {
	...
	this.simple_timer_comp.setTransform(400,260,0.5,0.5);
...
(lib.location_9_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance_4 = new lib.location_9_img();
	this.instance_4.setTransform(-65,-65,0.929,0.929);

	this.instance_5 = new lib.location_0_img();
	this.instance_5.setTransform(-65,-65,0.929,0.929);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4}]}).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(-292.1,-150,377.2,300);
p.frameBounds = [rect, rect=new cjs.Rectangle(-83,-83,166,166), rect, rect];
...
(lib.location_8_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance_4 = new lib.location_8_img();
	this.instance_4.setTransform(-65,-65,0.929,0.929);
...
(lib.location_7_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance_4 = new lib.location_7_img();
	this.instance_4.setTransform(-65,-65,0.929,0.929);
...
(lib.location_6_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance_4 = new lib.location_6_img();
	this.instance_4.setTransform(-65,-65,0.929,0.929);
...
(lib.location_5_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance_4 = new lib.location_5_img();
	this.instance_4.setTransform(-65,-65,0.929,0.929);
...
(lib.location_4_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance_4 = new lib.location_4_img();
	this.instance_4.setTransform(-65,-65,0.929,0.929);
...
(lib.location_3_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance_4 = new lib.location_3_img();
	this.instance_4.setTransform(-65,-65,0.929,0.929);
...
(lib.location_2_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance_4 = new lib.location_2_img();
	this.instance_4.setTransform(-65,-65,0.929,0.929);
...
(lib.location_1_mc = function(mode,startPosition,loop) {
	...
	// graph
	this.instance_4 = new lib.location_1_img();
	this.instance_4.setTransform(-65,-65,0.929,0.929);
...
(lib.WelcomeScreen = function(mode,startPosition,loop) {
	...
	this.freeGames_mc.setTransform(400,1000,0.727,0.727);
	...
	this.instance.setTransform(580,200);
	...
	this.instance_2.setTransform(298.1,278.1,0.444,0.444,0,0,0,0.1,0.1);

	this.instance_3 = new lib.blinking_star_3_mc();
	this.instance_3.setTransform(440.1,346.1,0.778,0.778,0,0,0,0.1,0.1);

	this.instance_4 = new lib.blinking_star_3_mc();
	this.instance_4.setTransform(360.1,214.1,0.556,0.556,0,0,0,0.1,0.1);
...
p.nominalBounds = rect = new cjs.Rectangle(-262.6,-280.8,1262.7,1324.4);
p.frameBounds = [rect];
...
p.nominalBounds = rect = new cjs.Rectangle(-170,-140,340,285);
p.frameBounds = [rect];
...
(lib.ResultScreen = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(514.1,495.1,0.333,0.333,0,0,0,0.3,0.3);

	this.instance_2 = new lib.blinking_star_3_mc();
	this.instance_2.setTransform(567.1,422.1,0.333,0.333,0,0,0,0.1,0.1);

	this.instance_3 = new lib.blinking_star_3_mc();
	this.instance_3.setTransform(579.1,483.1,0.556,0.556,0,0,0,0.1,0.1);
...
p.nominalBounds = rect = new cjs.Rectangle(-262.6,-319.9,1262.7,1165);
p.frameBounds = [rect];
...
p.nominalBounds = rect = new cjs.Rectangle(-452.1,-310,712.2,620);
p.frameBounds = [rect];
...
p.nominalBounds = rect = new cjs.Rectangle(-170,-140,340,285);
p.frameBounds = [rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, new cjs.Rectangle(-171,-140.8,342,286.6), new cjs.Rectangle(-171.9,-141.6,344,288.3), new cjs.Rectangle(-173,-142.4,346,290), new cjs.Rectangle(-173.9,-143.2,348,291.6), new cjs.Rectangle(-174.9,-144.1,350,293.3), new cjs.Rectangle(-175.9,-144.9,352,295), new cjs.Rectangle(-176.9,-145.7,354,296.7), new cjs.Rectangle(-177.9,-146.5,356,298.3), new cjs.Rectangle(-178.9,-147.3,358,300), new cjs.Rectangle(-180,-148.2,360,301.7), new cjs.Rectangle(-177.9,-146.5,356,298.3), new cjs.Rectangle(-175.9,-144.9,352,295), new cjs.Rectangle(-173.9,-143.2,348,291.6), new cjs.Rectangle(-171.9,-141.6,344,288.3), new cjs.Rectangle(-170,-140,340,285)];
...
(lib.LocationScreen_9 = function(mode,startPosition,loop) {
	...
	// timer
	this.simple_timer_comp = new lib.simple_timer_1_mc();
	this.simple_timer_comp.setTransform(490.2,35.2,0.276,0.275,0,0,0,0.6,0.6);
...
(lib.LocationScreen_5 = function(mode,startPosition,loop) {
	...
	// timer
	this.simple_timer_comp = new lib.simple_timer_1_mc();
	this.simple_timer_comp.setTransform(500.2,60.2,0.276,0.275,0,0,0,0.6,0.6);
...
(lib.LocationScreen_2 = function(mode,startPosition,loop) {
	...
	// timer
	this.simple_timer_comp = new lib.simple_timer_1_mc();
	this.simple_timer_comp.setTransform(535.2,85.2,0.276,0.275,0,0,0,0.6,0.6);
...
(lib.LocationScreen_1 = function(mode,startPosition,loop) {
	...
	// timer
	this.simple_timer_comp = new lib.simple_timer_1_mc();
	this.simple_timer_comp.setTransform(530.2,90.2,0.276,0.275,0,0,0,0.6,0.6);

	this.timeline.addTween(cjs.Tween.get(this.simple_timer_comp).wait(1));

	// decor
	this.instance = new lib.timer_bg_mc();
	this.instance.setTransform(530,90,0.848,0.848);
...
(lib.storage_1 = function(mode,startPosition,loop) {
	...
	this.instance_17 = new lib.PiecesPuzzle();
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text}]}).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.sound_mc},{t:this.fullScreen_mc},{t:this.instance_16},{t:this.gravity_explosion_comp}]},1).to({state:[{t:this.instance_17}]},1).to({state:[{t:this.instance_18}]},1).to({state:[{t:this.instance_19}]},1).to({state:[]},1).to({state:[{t:this.instance_20}]},8).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(0,0,256.5,75.5);
p.frameBounds = [rect, rect=new cjs.Rectangle(-200,0,1200,600), rect, new cjs.Rectangle(-262.6,-280.8,1262.7,1320.9), rect=new cjs.Rectangle(-262.6,-280.8,1262.7,1161.9), rect, rect, rect, rect, rect, rect, rect, rect, rect, new cjs.Rectangle(-200,0,1200,610), new cjs.Rectangle(-262.6,-319.9,1262.7,1165), new cjs.Rectangle(-200,0,1200,600), new cjs.Rectangle(15,15,263,70), null, new cjs.Rectangle(-200,-10,1200,620), new cjs.Rectangle(-1000,0,2800,600), rect=null, rect, rect, rect, rect, rect, rect, rect, new cjs.Rectangle(-410,-10,1620,620)];
