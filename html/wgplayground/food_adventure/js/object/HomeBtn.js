...
game.object.HomeBtn = me.GUI_Object.extend({
	init: function(x, y, settings = {}){
		settings.texture = "UI";
		settings.image = game.textureMap.get(settings.texture);
		game.util.__populateAtlasIndices([
			"button_text_home","button_text_home_h"
		], settings);
		...
		this.addAnimation('idle', [{ name: "button_text_home", delay: 100 }]);
		this.addAnimation('select', [{ name: "button_text_home_h", delay: 100 }]);
