...
game.object.BtnPauseContinue = me.GUI_Object.extend({
	init: function(x, y, settings = {}){
		settings.texture = "UI";
		settings.image = game.textureMap.get(settings.texture);
		game.util.__populateAtlasIndices([
			"button_text_continue_h","button_text_continue"
		], settings);
		...
		this.addAnimation('idle', [{ name: "button_text_continue", delay: 100 }]);
		this.addAnimation('select', [{ name: "button_text_continue_h", delay: 100 }]);
