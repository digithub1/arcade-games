...
game.object.BtnSFX = me.GUI_Object.extend({
	init: function(x, y, settings = {}){
		settings.texture = "UI";
		settings.image = game.textureMap.get(settings.texture);
		game.util.__populateAtlasIndices([
			"sound_off","sound_on","sound_off_h",
			"sound_on_h"
		], settings);
		...
		this.addAnimation('off', [{ name: "sound_off", delay: 100 }]);
		this.addAnimation('on', [{ name: "sound_on", delay: 100 }]);
		this.addAnimation('on_select', [{ name: "sound_on_h", delay: 100 }]);
		this.addAnimation('off_select', [{ name: "sound_off_h", delay: 100 }]);
