/*
* @author edapskov
* @copyright 2019 edapskov v 7.010
*/
function Application()
{
	...
	*/
	this.copyright = "© DL-Studio, v 7.010";
	/*
			...
			location_1:{
				...
				actions:{
					...
					action_8:{
						...
						addBackgroundSound:null,
						removeBackgroundSound:null,
						addCompletedSound:"completed_sound",
						removeCompletedSound:null,
						totalTime:180,
						currentTime:0
					}
		...
		heroes:
		{
			hero_1:{
				...
				currentDress:{
					...
					dress:{currentOption:null, defaultOption:6, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1673458531" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
