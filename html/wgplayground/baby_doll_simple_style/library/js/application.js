/*
* @author edapskov
* @copyright 2019 edapskov v 8.005
*/
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Baby Doll Simple Style";
	...
	*/
	this.copyright = "© DL-Studio, v 8.005";
	/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1680542863" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	function _resultFunc()
	{
		...
		*/
		if(_currentMainScreen_mc.vk_btn)
		{
			_currentMainScreen_mc.vk_btn.addEventListener("click", _onClickVkBtnFunc, false);
		}
		/*
	...
	*/
	function _addAdsFunc()
	{
		try
		{
			...
			*/
			window[window.preroll.config.loaderObjectName].refetchAd(midrollCallbackFunc);
		}
		catch(event)
		{
			/*
