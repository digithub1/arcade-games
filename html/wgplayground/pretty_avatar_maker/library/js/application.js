...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Pretty Avatar Maker";
	...
	*/
	this.copyright = "© DL-Studio, v 6.1";
	/*
		...
		heroes:{
			hero_1:{
				...
				dress:{
					...
					nose:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					scars:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					lips:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					shadows:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					leftEye:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					rightEye:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					eyebrows:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					...
					earrings:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					headdress:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					glasses:{currentOption:null, currentColor:null, defaultOption:0, defaultColor:null, totalOptions:null},
					glass:{currentOption:null, currentColor:null, defaultOption:1, defaultColor:null, totalOptions:null},
					...
					*/
					if(propCategories != _information.heroes[_information.currentHero].currentCategory)
					{
						...
						*/
						...
						{
							category_mc = category_mc["check_mc"];
							category_mc.gotoAndStop(0);
							...
							*/
							if(propSubcategories != _information.heroes[_information.currentHero].categories[_information.heroes[_information.currentHero].currentCategory].currentSubcategory)
							{
								...
								*/
								...
								{
									subcategory_mc = subcategory_mc["check_mc"];
									subcategory_mc.gotoAndStop(0);
									subcategory_mc.gotoAndStop(1);
								}
								else
								{
									subcategory_mc.alpha = 1;
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1653064972" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	function _onClickPhotoBtnFunc(event)
	{
		...
		*/
		photoContainer_mc.cache(160, 60, 480, 480, 1.0);
	...
	*/
	function _addAdsFunc()
	{
		if(_information.adsFlag)
		{
			...
			{
				_information.adsFlag = false;
				_information.timeout_id = setTimeout(_updateAdsFlagFunc, 180000);
			}
		}
	}
	function _updateAdsFlagFunc()
	{
		_information.adsFlag = true;
		if(_information.timeout_id != null)
		{
			clearTimeout(_information.timeout_id);
		}
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3356" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
