...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "BTS Chibi Claw Machine";
	...
	*/
	function _increasingLuckGameScreenFunc()
	{
		/*
		
		*/
		if(_information.currentRewards[_information.currentRewards.length - 1] == 0)
		{
			//trace("Бонус перемещения!");
			_information.currentRewards.splice(Number(_information.currentRewards.length - 1), 1);
		}
		/*
		
		*/
		if((_information.currentRewards[_information.currentRewards.length - 1] == 0) && (Math.random() > 0.5))
		{
			//trace("Случайный бонус!");
			_information.currentRewards.splice(Number(_information.currentRewards.length - 1), 1);
		}
	}
	/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dressupwho.net/html5/BlackPink-Chibi-Claw-Machine" + "?utm_source=" + _getLocationFunc() + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
