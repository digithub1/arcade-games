...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "Monster Girls on Valentine Day";
	...
	*/
	this.copyright = "© DL-Studio, v 8.3";
	/*
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dressupwho.net/html5/Monster-xmas" + "?utm_source=" + _getLocationFunc() + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
