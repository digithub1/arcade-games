...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "Royal Rebellion Punk Magic";
	...
	var _information = {
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					piercing_0:{rewarded:false},
					piercing_1:{rewarded:false},
					piercing_2:{rewarded:false},
					piercing_3:{rewarded:false},
					piercing_4:{rewarded:false},
					piercing_5:{rewarded:false},
					piercing_6:{rewarded:false},
				...
				currentDress:{
					piercing:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
	...
	*/
	function _preloaderFunc()
	{
		...
		*/
		...
		loadQueue.loadFile({id:"dust_sound", src:"library/sounds/dust_sound.ogg"});
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1740763777" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
