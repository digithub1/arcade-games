/*
* @author edapskov
* @copyright 2019 edapskov v 3.000
* for CreateJS 1.0
*/
/*
==============================================================================================================
...
function Edapskov_SoundManager()
{
	...
	*/
	...
	var _invisible_bool = false; // блокировка звука
	/*
	...
	*/
	function _setInvisibleFunc(invisible_bool)
	{
		...
		*/
		...
		{
			_invisible_bool = false;
		}
		else
		{
			_invisible_bool = Boolean(invisible_bool);
		}
		/*
...
function Edapskov_TimelineControl(currentMovieClip_mc)
{
	...
	*/
	...
	{
		trace("Не указан MovieClip для TimelineControl!");
	}
	/*
	
	*/
	this.gotoFunc = function(targetFrame, speed_num, params_arr)
	{
		_gotoFunc(targetFrame, speed_num, params_arr);
	}
	/*
	...
	*/
	...
	{
		_gotoFunc(undefined, undefined, params_arr);
	}
	/*
	
	*/
	function _gotoFunc(targetFrame, speed_num, params_arr)
	{
			...
			*/
			if (_beginFrame_num !== _targetFrame_num)
			{
				...
				*/
				...
				/*
				вроде, дубликаты отбрасываются и можно без этого, но всё же...
				*/
				try
				{
...
==============================================================================================================
*/
function Edapskov_AnimationUintInTextField(textField_txt, startValue_num, finalValue_num, step_num, prefix_str, postfix_str)
{
	/*
