...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "From Nerds to Beauties";
			...
			location_1:{
				...
				actions:{
					...
					action_14:{
						...
						skipAndGoto:null,
						openLocFunc:null,
						closeLocFunc:_closeLocFunc_14_1,
						addBackgroundSound:null,
						removeBackgroundSound:null,
						addCompletedSound:null,
						removeCompletedSound:null,
			...
			location_4:{
				...
				actions:{
					...
					action_21:{
						...
						skipAndGoto:null,
						openLocFunc:null,
						closeLocFunc:_closeLocFunc_21_4,
						addBackgroundSound:null,
						removeBackgroundSound:null,
						addCompletedSound:null,
						removeCompletedSound:null,
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1738436892" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
