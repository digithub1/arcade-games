/*
* @author edapskov
* @copyright 2019 edapskov v 8.011
*/
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "Venetian Love Affair";
	...
	*/
	this.copyright = "© DL-Studio, v 8.011";
	/*
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					...
					base_0:{rewarded:false},
					base_1:{rewarded:false},
					base_2:{rewarded:false},
					base_3:{rewarded:false},
					base_4:{rewarded:false},
					base_5:{rewarded:false},
					base_6:{rewarded:false},
					base_7:{rewarded:false},
					base_8:{rewarded:false},
					base_9:{rewarded:false},
					pattern_0:{rewarded:false},
					pattern_1:{rewarded:false},
					pattern_2:{rewarded:false},
					pattern_3:{rewarded:false},
					pattern_4:{rewarded:false},
					pattern_5:{rewarded:false},
					pattern_6:{rewarded:false},
					pattern_7:{rewarded:false},
					pattern_8:{rewarded:false},
					pattern_9:{rewarded:false},
					eyeshadow_0:{rewarded:false},
					eyeshadow_1:{rewarded:false},
					eyeshadow_2:{rewarded:false},
					eyeshadow_3:{rewarded:false},
					eyeshadow_4:{rewarded:false},
					eyeshadow_5:{rewarded:false},
					eyeshadow_6:{rewarded:false},
					eyeshadow_7:{rewarded:false},
					eyeshadow_8:{rewarded:false},
					eyeshadow_9:{rewarded:false},
					ornament_0:{rewarded:false},
					ornament_1:{rewarded:false},
					ornament_2:{rewarded:false},
					ornament_3:{rewarded:false},
					ornament_4:{rewarded:false},
					ornament_5:{rewarded:false},
					ornament_6:{rewarded:false},
					ornament_7:{rewarded:false},
					ornament_8:{rewarded:false},
					ornament_9:{rewarded:false},
					curl_0:{rewarded:false},
					curl_1:{rewarded:false},
					curl_2:{rewarded:false},
					curl_3:{rewarded:false},
					curl_4:{rewarded:false},
					curl_5:{rewarded:false},
					curl_6:{rewarded:false},
					curl_7:{rewarded:false},
					curl_8:{rewarded:false},
					curl_9:{rewarded:false},
					plume_0:{rewarded:false},
					plume_1:{rewarded:false},
					plume_2:{rewarded:false},
					plume_3:{rewarded:false},
					plume_4:{rewarded:false},
					plume_5:{rewarded:false},
					plume_6:{rewarded:false},
					plume_7:{rewarded:false},
					plume_8:{rewarded:false},
					plume_9:{rewarded:false},
					...
					fan_0:{rewarded:false},
					fan_1:{rewarded:false},
					fan_2:{rewarded:false},
					fan_3:{rewarded:false},
					fan_4:{rewarded:false},
					fan_5:{rewarded:false},
					fan_6:{rewarded:false},
					fan_7:{rewarded:false},
					fan_8:{rewarded:false},
					fan_9:{rewarded:false},
					bg_0:{rewarded:false},
					bg_1:{rewarded:false}
				},
				currentDress:{
					...
					base:{currentOption:null, defaultOption:1, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
					pattern:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
					eyeshadow:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
					ornament:{currentOption:null, defaultOption:1, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
					curl:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
					plume:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
					...
					fan:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1706636571" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
