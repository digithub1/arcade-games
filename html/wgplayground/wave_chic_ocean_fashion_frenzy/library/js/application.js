...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Wave Chic Ocean Fashion Frenzy";
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					...
					board_0:{rewarded:false},
					board_1:{rewarded:false},
					board_2:{rewarded:false},
					board_3:{rewarded:false},
					board_4:{rewarded:false},
					board_5:{rewarded:false},
					board_6:{rewarded:false},
					...
					accessory_13:{rewarded:false},
					accessory_14:{rewarded:false},
					accessory_15:{rewarded:false},
					accessory_16:{rewarded:false},
					accessory_17:{rewarded:false},
					accessory_18:{rewarded:false},
				...
				currentDress:{
					...
					board:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1717539739" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	...
	function _openLocFunc_1_5()
	{
		...
		_information.heroes.hero_1.currentDress.board.currentOption = 1;
	}
	function _openLocFunc_1_6()
	{
		_information.currentNameHero = "hero_2";
		_information.heroes[_information.currentNameHero].currentSet = "set_3";
		_information.heroes.hero_2.currentDress.board.currentOption = 1;
	}
	/*
	ссылки
	*/
