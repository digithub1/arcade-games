...
function initLobby() {
	...
	document.getElementById("lobbyMoreBtn").addEventListener("click", (e) => {
        window.open("https://newkidsgames.org/?utm_source=WeeGoo&utm_medium=drift_boss_3d", target="_blank");
    });
