...
function Application()
{
	...
	*/
	function _preloaderFunc()
	{
		...
		*/
		...
		loadQueue.loadFile({id:"run_sound", src:"library/sounds/run_sound.ogg"});
		loadQueue.loadFile({id:"loss_sound", src:"library/sounds/loss_sound.ogg"});
		loadQueue.loadFile({id:"shot_sound", src:"library/sounds/shot_sound.ogg"});
		...
		*/
		if(_information.locations[_information.currentNameLocation].actions.hasOwnProperty(_information.locations[_information.currentNameLocation].currentNameAction))
		{
			...
			*/
			...
			else if(_information.locations[_information.currentNameLocation].actions[_information.locations[_information.currentNameLocation].currentNameAction].type === "freezeGame")
			{
				/*
				...
				*/
				_beginFreezeGameActionFunc();
			}
			else if(_information.locations[_information.currentNameLocation].actions[_information.locations[_information.currentNameLocation].currentNameAction].type === "outlineGame")
			{
				/*
				...
				*/
				...
				if(key == "dress")
				{
					if(val > 0)
					{
						...
						if(_information.heroes[_information.currentNameHero].currentDress.hasOwnProperty("jacket"))
						{
							_information.heroes[_information.currentNameHero].currentDress.jacket.currentOption = 0;
						}
					}
					else
					{
	...
	*/
	...
	============================================================
	*/
	function _beginFreezeGameActionFunc()
	{
		/*
		
		*/
		if(!_information.hasOwnProperty("freezeGameRunFlag"))
		{
			_information.freezeGameRunFlag = null;
		}
		else
		{
			_information.freezeGameRunFlag = null;
		}
		if(!_information.hasOwnProperty("freezeGameArrayHeroes"))
		{
			_information.freezeGameArrayHeroes = null;
		}
		else
		{
			_information.freezeGameArrayHeroes = null;
		}
		if(!_information.hasOwnProperty("freezeGameWatchingFlag"))
		{
			_information.freezeGameWatchingFlag = null;
		}
		else
		{
			_information.freezeGameWatchingFlag = null;
		}
		if(!_information.hasOwnProperty("freezeGameTurnedFlag"))
		{
			_information.freezeGameTurnedFlag = null;
		}
		else
		{
			_information.freezeGameTurnedFlag = null;
		...
		*/
		var freezeGame_mc = currentScreen_mc.body_mc["freezeGame_" + (currentScreen_mc.body_mc.currentFrame + 1) + "_mc"];
		freezeGame_mc.gotoAndStop(0);
		freezeGame_mc.mouseEnabled = false;
		freezeGame_mc.mouseChildren = false;
		freezeGame_mc.cursor = "default";
		/*
		
		*/
		if(!_information.hasOwnProperty("freezeGameMC"))
		{
			_information.freezeGameMC = freezeGame_mc;
		}
		else
		{
			_information.freezeGameMC = freezeGame_mc;
		...
		*/
		if(freezeGame_mc.messages_mc)
		{
			freezeGame_mc.messages_mc.gotoAndStop(0);
			freezeGame_mc.messages_mc.mouseEnabled = false;
			freezeGame_mc.messages_mc.mouseChildren = false;
			freezeGame_mc.messages_mc.cursor = "default";
		}
		else
		{
			trace("Отсутствует messages_mc!");
		}
		/*
		
		*/
		if(freezeGame_mc.players_mc)
		{
			freezeGame_mc.players_mc.gotoAndStop(0);
			freezeGame_mc.players_mc.mouseEnabled = false;
			freezeGame_mc.players_mc.mouseChildren = false;
			freezeGame_mc.players_mc.cursor = "default";
		}
		else
		{
			trace("Отсутствует leading_mc!");
		}
		/*
		
		*/
		if(freezeGame_mc.leading_mc)
		{
			freezeGame_mc.leading_mc.gotoAndStop(0);
			freezeGame_mc.leading_mc.mouseEnabled = false;
			freezeGame_mc.leading_mc.mouseChildren = false;
			freezeGame_mc.leading_mc.cursor = "default";
		}
		else
		{
			trace("Отсутствует leading_mc!");
		...
		*/
		if(freezeGame_mc.track_mc)
		{
			freezeGame_mc.track_mc.gotoAndStop(0);
			freezeGame_mc.track_mc.mouseEnabled = false;
			freezeGame_mc.track_mc.mouseChildren = false;
			freezeGame_mc.track_mc.cursor = "default";
		}
		else
		{
			trace("Отсутствует track_mc!");
		}
		/*
		
		*/
		_prepareStartFreezeGameActionFunc();
	}
	function _prepareStartFreezeGameActionFunc(replay_bool)
	{
		/*
		...
		*/
		_information.freezeGameRunFlag = false;
		_information.freezeGameArrayHeroes = new Array();
		_information.freezeGameWatchingFlag = false;
		_information.freezeGameTurnedFlag = false;
		/*
		
		*/
		var freezeGame_mc = _information.freezeGameMC;
		/*
		
		*/
		freezeGame_mc.messages_mc.visible = false;
		freezeGame_mc.messages_mc.gotoAndStop("start");
		/*
		
		*/
		freezeGame_mc.players_mc.alpha = 0.01;
		freezeGame_mc.players_mc.x = -200;
		freezeGame_mc.players_mc.y = 0;
		createjs.Tween.get(freezeGame_mc.players_mc).wait(0).to({alpha:1.0, x:0, y:0}, 1000).call(_startFreezeGameActionFunc);
		/*
		
		*/
		_createArrayHeroesFreezeGameActionFunc();
		_updatePlayersFreezeGameActionFunc(1);
		/*
		
		*/
		_soundManager.addSoundFunc("run_sound", 0, 0, 0, 0.2, 0);
		/*
		
		*/
		freezeGame_mc.leading_mc.gotoAndStop("beginning");
		/*
		
		*/
		freezeGame_mc.track_mc.gotoAndStop(0);
	}
	function _startFreezeGameActionFunc()
	{
		/*
		...
		*/
		freezeGame_mc.mouseEnabled = true;
		freezeGame_mc.mouseChildren = false;
		freezeGame_mc.cursor = "pointer";
		freezeGame_mc.addEventListener("mousedown", _onMouseDownFreezeGameMcFreezeGameActionFunc, false);
		freezeGame_mc.addEventListener("pressup", _onPressUpFreezeGameMcFreezeGameActionFunc, false);
		/*
		
		*/
		freezeGame_mc.messages_mc.visible = true;
		freezeGame_mc.messages_mc.gotoAndStop("start");
		/*
		
		*/
		freezeGame_mc.players_mc.alpha = 1.0;
		freezeGame_mc.players_mc.x = 0;
		freezeGame_mc.players_mc.y = 0;
		/*
		
		*/
		_updatePlayersFreezeGameActionFunc(2);
		/*
		
		*/
		freezeGame_mc.track_mc.addEventListener("tick", _onTickTrackMcFreezeGameActionFunc, false);
		/*
		
		*/
		freezeGame_mc.leading_mc.addEventListener("tick", _onTickLeadingMcFreezeGameActionFunc, false);
		/*
	...
	*/
	function _onMouseDownFreezeGameMcFreezeGameActionFunc(event)
	{
		/*
		
		*/
		_information.freezeGameRunFlag = true;
		/*
		...
		*/
		if(freezeGame_mc.messages_mc.visible)
		{
			freezeGame_mc.messages_mc.visible = false;
		}
		/*
		...
		*/
		freezeGame_mc.track_mc.play();
		/*
		
		*/
		_updateLeadingMcFreezeGameActionFunc();
	}
	function _onPressUpFreezeGameMcFreezeGameActionFunc(event)
	{
		_stopRunningFreezeGameActionFunc();
	}
	function _stopRunningFreezeGameActionFunc()
	{
		/*
		...
		*/
		freezeGame_mc.track_mc.stop();
	}
	function _onTickTrackMcFreezeGameActionFunc(event)
	{
		/*
		...
		*/
		var currentFrame_num = freezeGame_mc.track_mc.currentFrame;
		var totalFrames_num = freezeGame_mc.track_mc.totalFrames;
		/*
		
		*/
		if((currentFrame_num + 1) >= totalFrames_num)
		{
			_winFreezeGameActionFunc();
		}
	}
	/*
	
	*/
	function _updateLeadingMcFreezeGameActionFunc()
	{
		/*
		...
		*/
		...
		_information.timeout_id = setTimeout(_beginTurnLeadingMcFreezeGameActionFunc, (1000 * (Math.random() * 3)) + 2000);
		/*
	...
	function _beginTurnLeadingMcFreezeGameActionFunc()
	{
		/*
		...
		*/
		freezeGame_mc.leading_mc.play();
	}
	function _onTickLeadingMcFreezeGameActionFunc(event)
	{
		/*
		...
		*/
		var currentLabel_str = freezeGame_mc.leading_mc.currentLabel;
		var chances_num;
		var hero_mc;
		/*
		
		*/
		if(currentLabel_str == "watching")
		{
			if(!_information.freezeGameWatchingFlag)
			{
				/*
				
				*/
				_information.freezeGameWatchingFlag = true;
				/*
				
				*/
				if(_information.freezeGameRunFlag)
				{
					_lossFreezeGameActionFunc();
				}
				else
				{
					/*
					...
					*/
					if(_information.freezeGameArrayHeroes.length > 0)
					{
						/*
						
						*/
						chances_num = Math.floor(Math.random() * 2);
						/*
						...
						*/
						if(chances_num == 0)
						{
							...
							*/
							hero_mc = _information.freezeGameArrayHeroes[0];
							_information.freezeGameArrayHeroes.splice(0, 1);
							/*
							
							*/
							hero_mc.gotoAndStop("loss");
							/*
							
							*/
							_soundManager.addSoundFunc("shot_sound", 0.5, 0, 0, 0.4, 0);
						}
					}
				}
			}
		}
		else if(currentLabel_str == "turned")
		{
			if(!_information.freezeGameTurnedFlag)
			{
				/*
				
				*/
				_information.freezeGameTurnedFlag = true;
				/*
				...
				*/
				freezeGame_mc.leading_mc.gotoAndStop("turned");
			}
		}
		else
		{
	...
	*/
	function _winFreezeGameActionFunc()
	{
		/*
		...
		*/
		...
		_information.timeout_id = setTimeout(_updateCurrentActionFunc, 3000);
		/*
		...
		*/
		...
		freezeGame_mc.mouseChildren = false;
		freezeGame_mc.cursor = "default";
		freezeGame_mc.removeEventListener("mousedown", _onMouseDownFreezeGameMcFreezeGameActionFunc, false);
		freezeGame_mc.removeEventListener("pressup", _onPressUpFreezeGameMcFreezeGameActionFunc, false);
		/*
		
		*/
		freezeGame_mc.messages_mc.visible = true;
		freezeGame_mc.messages_mc.gotoAndStop("win");
		/*
		
		*/
		createjs.Tween.get(freezeGame_mc.players_mc).wait(0).to({alpha:0.01, x:_CWIDTH, y:0}, 1000);
		/*
		
		*/
		freezeGame_mc.track_mc.stop();
		freezeGame_mc.track_mc.removeEventListener("tick", _onTickTrackMcFreezeGameActionFunc, false);
		/*
		
		*/
		freezeGame_mc.leading_mc.gotoAndStop("beginning");
		freezeGame_mc.leading_mc.removeEventListener("tick", _onTickLeadingMcFreezeGameActionFunc, false);
		/*
		...
		*/
		_soundManager.addSoundFunc("win_sound", 0, 0, 0, 0.4, 0);
		/*
		удаление переменных
		*/
		_information.freezeGameMC = null;
		_information.freezeGameRunFlag = null;
		_information.freezeGameArrayHeroes = null;
		_information.freezeGameWatchingFlag = null;
		_information.freezeGameTurnedFlag = null;
	}
	function _lossFreezeGameActionFunc()
	{
		/*
		...
		*/
		...
		_information.timeout_id = setTimeout(_tryAgainFreezeGameActionFunc, 2000);
		/*
		...
		*/
		_updatePlayersFreezeGameActionFunc(3);
		/*
		...
		*/
		freezeGame_mc.leading_mc.gotoAndStop("loss");
		freezeGame_mc.leading_mc.removeEventListener("tick", _onTickLeadingMcFreezeGameActionFunc, false);
		/*
		...
		*/
		_soundManager.addSoundFunc("shot_sound", 0, 0, 0, 1, 0);
		/*
		
		*/
		_soundManager.addSoundFunc("loss_sound", 0.5, 0, 0, 0.4, 0);
	}
	function _tryAgainFreezeGameActionFunc()
	{
		/*
		...
		*/
		...
		freezeGame_mc.mouseChildren = false;
		freezeGame_mc.cursor = "pointer";
		freezeGame_mc.addEventListener("mousedown", _onMouseDownTryAgainFreezeGameActionFunc, false);
		/*
		
		*/
		freezeGame_mc.messages_mc.visible = true;
		freezeGame_mc.messages_mc.gotoAndStop("loss");
	}
	function _onMouseDownTryAgainFreezeGameActionFunc(event)
	{
		/*
		...
		*/
		currentTarget_mc.removeEventListener("mousedown", _onMouseDownTryAgainFreezeGameActionFunc, false);
		/*
	...
	*/
	function _updatePlayersFreezeGameActionFunc(flag_num)
	{
		/*
		...
		*/
		if(freezeGame_mc.players_mc)
		{
			...
			*/
			i = 0;
			l = freezeGame_mc.players_mc.numChildren;
			/*
			...
			*/
			while(i < l)
			{
				...
				*/
				player_str = "player_" + i + "_mc";
				/*
				
				*/
				if(freezeGame_mc.players_mc[player_str])
				{
					/*
					
					*/
					player_mc = freezeGame_mc.players_mc[player_str];
					/*
					
					*/
					if(flag_num == 1)
					{
						player_mc.gotoAndStop("run");
					} 
					if (flag_num == 2)
					{
						player_mc.gotoAndStop("freeze");
					}
					if (flag_num == 3)
					{
						if(i == 0)
						{
							player_mc.gotoAndStop("loss");
						}
						else
						{
							player_mc.gotoAndStop("freeze");
	...
	function _createArrayHeroesFreezeGameActionFunc()
	{
		/*
				...
				*/
				if(freezeGame_mc.players_mc[player_str])
				{
					...
					*/
					if(i != 0)
					{
						_information.freezeGameArrayHeroes.splice(Math.floor(Math.random()*_information.freezeGameArrayHeroes.length), 0, player_mc);
					}
				}
				/*
	...
	============================================================
	*/
	function _beginOutlineGameActionFunc()
	{
		/*
		
		*/
		if(!_information.hasOwnProperty("arrayDotsOutlineGame"))
		{
			_information.arrayDotsOutlineGame = null;
		}
		else
		{
			_information.arrayDotsOutlineGame = null;
		}
		if(!_information.hasOwnProperty("targetDotOutlineGame"))
		{
			_information.targetDotOutlineGame = null;
		}
		else
		{
			_information.targetDotOutlineGame = null;
		}
		if(!_information.hasOwnProperty("currentTimeOutlineGame"))
		{
			_information.currentTimeOutlineGame = null;
		}
		else
		{
			_information.currentTimeOutlineGame = null;
		}
		if(!_information.hasOwnProperty("totalTimeOutlineGame"))
		{
			_information.totalTimeOutlineGame = null;
		}
		else
		{
			_information.totalTimeOutlineGame = null;
		...
		*/
		var outlineGame_mc = currentScreen_mc.body_mc["outlineGame_" + (currentScreen_mc.body_mc.currentFrame + 1) + "_mc"];
		outlineGame_mc.gotoAndStop(0);
		/*
		
		*/
		if(!_information.hasOwnProperty("outlineGameMC"))
		{
			_information.outlineGameMC = outlineGame_mc;
		}
		else
		{
			_information.outlineGameMC = outlineGame_mc;
		...
		*/
		if(outlineGame_mc.messages_mc)
		{
			outlineGame_mc.messages_mc.gotoAndStop(0);
			outlineGame_mc.messages_mc.mouseEnabled = false;
			outlineGame_mc.messages_mc.mouseChildren = false;
		}
		else
		{
			trace("Отсутствует messages_mc!");
		...
		*/
		if(outlineGame_mc.options_mc)
		{
			outlineGame_mc.options_mc.gotoAndStop(0);
			outlineGame_mc.options_mc.mouseEnabled = false;
			outlineGame_mc.options_mc.mouseChildren = false;
		}
		else
		{
			trace("Отсутствует options_mc!");
		}
		/*
		
		*/
		_prepareStartOutlineGameActionFunc();
	}
	function _prepareStartOutlineGameActionFunc(replay_bool)
	{
		/*
		...
		*/
		...
		обновление переменных
		*/
		_information.arrayDotsOutlineGame = new Array();
		_information.targetDotOutlineGame = 0;
		_information.currentTimeOutlineGame = 0;
		if(_information.locations[_information.currentNameLocation].actions[_information.locations[_information.currentNameLocation].currentNameAction].totalTime)
		{
			_information.totalTimeOutlineGame = Number(_information.locations[_information.currentNameLocation].actions[_information.locations[_information.currentNameLocation].currentNameAction].totalTime);
		}
		else
		{
			_information.totalTimeOutlineGame = 15;
		}
		/*
		
		*/
		var outlineGame_mc = _information.outlineGameMC;
		/*
		
		*/
		outlineGame_mc.mouseEnabled = true;
		outlineGame_mc.mouseChildren = false;
		outlineGame_mc.cursor = "pointer";
		outlineGame_mc.addEventListener("pressup", _onPressUpStartGameOutlineGameActionFunc, false);
		/*
		
		*/
		outlineGame_mc.messages_mc.visible = true;
		outlineGame_mc.messages_mc.gotoAndStop("start");
		/*
		
		*/
		var randomFrame_num = Math.floor(Math.random() * outlineGame_mc.options_mc.totalFrames);
		outlineGame_mc.options_mc.gotoAndStop(randomFrame_num);
		/*
		
		*/
		var option_str = "body_" + Number(randomFrame_num + 1) + "_mc";
		var option_mc;
		if(outlineGame_mc.options_mc[option_str])
		{
			/*
			
			*/
			option_mc = outlineGame_mc.options_mc[option_str];
			option_mc.gotoAndStop(0);
			/*
			
			*/
			if(!_information.hasOwnProperty("optionOutlineGameMC"))
			{
				_information.optionOutlineGameMC = option_mc;
			}
			else
			{
				_information.optionOutlineGameMC = option_mc;
			...
			*/
			if(option_mc.dots_mc)
			{
				/*
				
				*/
				option_mc.dots_mc.gotoAndStop(0);
				option_mc.dots_mc.x = 0;
				option_mc.dots_mc.y = 0;
				option_mc.dots_mc.visible = false;
				/*
				
				*/
				_updateDotsOutlineGameActionFunc();
				/*
				
				*/
				_updateTargetDotOutlineGameActionFunc();
			}
			else
			{
				trace("Отсутствует dots_mc!");
			}
			/*
			
			*/
			if(option_mc.drawing_mc)
			{
				/*
				
				*/
				option_mc.drawing_mc.gotoAndStop(0);
				option_mc.drawing_mc.x = 0;
				option_mc.drawing_mc.y = 0;
				option_mc.drawing_mc.visible = false;
				/*
				
				*/
				_clearContainerFunc(option_mc.drawing_mc);
				/*
				
				*/
				var drawing_shape = new createjs.Shape();
				option_mc.drawing_mc.addChild(drawing_shape);
				drawing_shape.name = "drawing_shape";
			}
			else
			{
				trace("Отсутствует drawing_mc!");
			}
			/*
			
			*/
			if(option_mc.animation_mc)
			{
				option_mc.animation_mc.gotoAndStop(0);
				option_mc.animation_mc.gotoAndStop("start");
			}
			else
			{
				trace("Отсутствует animation_mc!");
			}
		}
		else
		{
			trace("Отсутствует option_mc!");
		}
		/*
		
		*/
		_updateIndicatorFunc(1);
	}
	function _onPressUpStartGameOutlineGameActionFunc(event)
	{
		/*
		
		*/
		_information.interval_id = setInterval(_updateIndicatorOutlineGameActionFunc, 1000);
		/*
		...
		*/
		...
		outlineGame_mc.mouseChildren = false;
		outlineGame_mc.cursor = "pointer";
		outlineGame_mc.removeEventListener("pressup", _onPressUpStartGameOutlineGameActionFunc, false);
		outlineGame_mc.addEventListener("mousedown", _onMouseDownGameOutlineGameActionFunc, false);
		outlineGame_mc.addEventListener("pressup", _onPressUpGameOutlineGameActionFunc, false);
		outlineGame_mc.addEventListener("mouseout", _onPressUpGameOutlineGameActionFunc, false);
		/*
		...
		*/
		outlineGame_mc.messages_mc.visible = false;
		/*
		
		*/
		var option_mc = _information.optionOutlineGameMC;
		/*
		
		*/
		option_mc.dots_mc.visible = true;
		/*
		
		*/
		option_mc.drawing_mc.visible = true;
		/*
		
		*/
		if(option_mc.animation_mc)
		{
			option_mc.animation_mc.gotoAndStop("game");
		}
	}
	function _onMouseDownGameOutlineGameActionFunc(event)
	{
		/*
		...
		*/
		outlineGame_mc.addEventListener("pressmove", _onPressMoveGameOutlineGameActionFunc, false);
	}
	function _onPressUpGameOutlineGameActionFunc(event)
	{
		/*
		...
		*/
		_updateDrawingOutlineGameActionFunc();
		/*
		...
		*/
		outlineGame_mc.removeEventListener("pressmove", _onPressMoveGameOutlineGameActionFunc, false);
	}
	function _onPressMoveGameOutlineGameActionFunc(event)
	{
		/*
		...
		*/
		if(option_mc.dots_mc[_information.arrayDotsOutlineGame[_information.targetDotOutlineGame][0]])
		{
			/*
			
			*/
			targetDot_mc = option_mc.dots_mc[_information.arrayDotsOutlineGame[_information.targetDotOutlineGame][0]];
			/*
			
			*/
			point_obj = event.currentTarget.localToLocal(event.localX, event.localY, targetDot_mc);
			if(targetDot_mc.hitTest(point_obj.x, point_obj.y))
			{
				/*
				
				*/
				_information.targetDotOutlineGame++;
				/*
				...
				*/
				if(_information.targetDotOutlineGame >= _information.arrayDotsOutlineGame.length)
				{
					_winOutlineGameActionFunc();
				}
				/*
	...
	*/
	function _updateIndicatorOutlineGameActionFunc()
	{
		/*
		
		*/
		_information.currentTimeOutlineGame += 1;
		/*
		
		*/
		var share_num = (_information.totalTimeOutlineGame - _information.currentTimeOutlineGame) / _information.totalTimeOutlineGame;
		/*
		...
		*/
		if(share_num < 0)
		{
			_lossOutlineGameActionFunc();
		}
	}
	/*
	
	*/
	function _winOutlineGameActionFunc()
	{
		/*
		...
		*/
		...
		_information.timeout_id = setTimeout(_updateCurrentActionFunc, 5000);
		if(_information.interval_id != null)
		{
			clearInterval(_information.interval_id);
		}
		...
		*/
		outlineGame_mc.mouseEnabled = false;
		outlineGame_mc.mouseChildren = false;
		outlineGame_mc.cursor = "default";
		outlineGame_mc.removeEventListener("mousedown", _onMouseDownGameOutlineGameActionFunc, false);
		outlineGame_mc.removeEventListener("pressup", _onPressUpGameOutlineGameActionFunc, false);
		outlineGame_mc.removeEventListener("mouseout", _onPressUpGameOutlineGameActionFunc, false);
		outlineGame_mc.removeEventListener("pressmove", _onPressMoveGameOutlineGameActionFunc, false);
		/*
		
		*/
		outlineGame_mc.messages_mc.alpha = 0.01;
		outlineGame_mc.messages_mc.visible = true;
		outlineGame_mc.messages_mc.gotoAndStop("win");
		createjs.Tween.get(outlineGame_mc.messages_mc).wait(2000).to({alpha:1.0}, 1000);
		/*
		...
		*/
		if(option_mc.animation_mc)
		{
			option_mc.animation_mc.gotoAndStop("win");
		}
		/*
		...
		*/
		...
		удаление переменных
		*/
		_information.outlineGameMC = null;
		_information.optionOutlineGameMC = null;
		_information.arrayDotsOutlineGame = null;
		_information.targetDotOutlineGame = null;
		_information.currentTimeOutlineGame = null;
		_information.totalTimeOutlineGame = null;
	}
	function _lossOutlineGameActionFunc()
	{
		/*
		...
		*/
		...
		_information.timeout_id = setTimeout(_tryAgainOutlineGameActionFunc, 2000);
		if(_information.interval_id != null)
		{
			clearInterval(_information.interval_id);
		}
		...
		*/
		if(option_mc.animation_mc)
		{
			option_mc.animation_mc.gotoAndStop("loss");
		}
		/*
	...
	function _tryAgainOutlineGameActionFunc()
	{
		/*
		...
		*/
		...
		outlineGame_mc.mouseChildren = false;
		outlineGame_mc.cursor = "pointer";
		outlineGame_mc.addEventListener("pressup", _onPressUpTryAgainOutlineGameActionFunc, false);
		/*
		
		*/
		outlineGame_mc.messages_mc.visible = true;
		outlineGame_mc.messages_mc.gotoAndStop("loss");
	}
	function _onPressUpTryAgainOutlineGameActionFunc(event)
	{
		/*
		...
		*/
		currentTarget_mc.removeEventListener("pressup", _onPressUpTryAgainOutlineGameActionFunc, false);
		/*
	...
	*/
	function _updateDotsOutlineGameActionFunc()
	{
		/*
		...
		*/
		if(option_mc.dots_mc && option_mc.drawing_mc)
		{
			/*
			
			*/
			i = 0;
			l = option_mc.dots_mc.numChildren;
			/*
			...
			*/
			while(i < l)
			{
				...
				*/
				if(option_mc.dots_mc[dot_str])
				{
					/*
					
					*/
					dot_mc = option_mc.dots_mc[dot_str];
					dot_mc.gotoAndStop(0);
					dot_mc.name = dot_str;
					/*
					...
					*/
					...
					dot_arr[1] = dot_mc.x;
					dot_arr[2] = dot_mc.y;
					_information.arrayDotsOutlineGame[i] = dot_arr;
				}
				else
				{
					trace("Не найдена точка с именем " + dot_str + "!");
				}
				/*
			...
			*/
			dot_arr = new Array();
			dot_arr[0] = _information.arrayDotsOutlineGame[0][0];
			dot_arr[1] = _information.arrayDotsOutlineGame[0][1];
			dot_arr[2] = _information.arrayDotsOutlineGame[0][2];
			_information.arrayDotsOutlineGame.push(dot_arr);
		}
	}
	function _updateTargetDotOutlineGameActionFunc()
	{
		/*
		...
		*/
		if(option_mc.dots_mc)
		{
			...
			*/
			i = 0;
			l = _information.arrayDotsOutlineGame.length;
			/*
			...
			*/
			while(i < l)
			{
				...
				*/
				if(option_mc.dots_mc[_information.arrayDotsOutlineGame[i][0]])
				{
					/*
					
					*/
					dot_mc = option_mc.dots_mc[_information.arrayDotsOutlineGame[i][0]];
					/*
					
					*/
					if(i < _information.targetDotOutlineGame)
					{
						/*
						...
						*/
						if(dot_mc.animation_mc)
						{
							dot_mc.animation_mc.gotoAndStop(0);
						}
					}
					else if(i > _information.targetDotOutlineGame)
					{
						if((i != 0) && (i != Number(l - 1)))
						{
					...
					else
					{
						...
						*/
						if(dot_mc.animation_mc)
						{
							dot_mc.animation_mc.gotoAndPlay(0);
						}
					}
				}
				/*
	...
	function _updateDrawingOutlineGameActionFunc()
	{
		/*
		...
		*/
		if(option_mc.drawing_mc)
		{
			...
			*/
			drawing_shape = option_mc.drawing_mc.getChildByName("drawing_shape");
			drawing_shape.graphics.clear();
			drawing_shape.graphics.setStrokeStyle(_INDENT, "round").beginStroke("#ff0000");
			/*
			
			*/
			i = 0;
			l = _information.targetDotOutlineGame;
			/*
			...
			*/
			while(i < l)
			{
				...
				*/
				if(i == 0)
				{
					drawing_shape.graphics.moveTo(_information.arrayDotsOutlineGame[i][1], _information.arrayDotsOutlineGame[i][2]);
				}
				else if(i >= (l - 1))
				{
					drawing_shape.graphics.lineTo(_information.arrayDotsOutlineGame[i][1], _information.arrayDotsOutlineGame[i][2]);
					drawing_shape.graphics.endStroke();
				}
				else
				{
					drawing_shape.graphics.lineTo(_information.arrayDotsOutlineGame[i][1], _information.arrayDotsOutlineGame[i][2]);
								...
								if(hero_mc[propObject])
								{
									...
									*/
									if(propObject == "dress")
									{
										...
										*/
										if(hero_mc.hair && hero_mc.fringe)
										{
											if(frame_num == 4 || frame_num == 6 || frame_num == 8 || frame_num == 9)
											{
												hero_mc.hair.visible = true;
												hero_mc.fringe.visible = true;
											}
											else
											{
												hero_mc.hair.visible = false;
												hero_mc.fringe.visible = false;
											}
										}
									}
								}
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1637507149" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
	...
	*/
	function _resultFunc()
	{
		...
		*/
		...
		if(currentScreen_mc.photoContainer_mc.heroes_mc.container_mc)
		{
			currentScreen_mc.photoContainer_mc.heroes_mc.container_mc.gotoAndStop(0);
			currentScreen_mc.photoContainer_mc.heroes_mc.container_mc.gotoAndStop(_information.currentNameLocation);
			_updateHeroesFunc(currentScreen_mc.photoContainer_mc.heroes_mc.container_mc);
		}
		/*
	...
	*/
	...
	function _createBackupPhotoFunc()
	{
		...
		*/
		...
		if(photoContainer_mc.heroes_mc.container_mc)
		{
			photoContainer_mc.heroes_mc.container_mc.gotoAndStop(0);
			photoContainer_mc.heroes_mc.container_mc.gotoAndStop(_information.currentNameLocation);
			_updateHeroesFunc(photoContainer_mc.heroes_mc.container_mc);
		}
		/*
	...
	*/
	...
	{
		window.open("https://dl-girls.com/index.php?controller=article&action=index&id=3038" + "&utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_blank");
	}
