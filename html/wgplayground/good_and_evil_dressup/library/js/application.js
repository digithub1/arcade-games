...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "Good and Evil DressUp";
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					...
					stock_0:{rewarded:false},
					stock_1:{rewarded:false},
					stock_2:{rewarded:false},
					stock_3:{rewarded:false},
					shoes_0:{rewarded:false},
					shoes_1:{rewarded:false},
					shoes_2:{rewarded:false},
					shoes_3:{rewarded:false},
					bracers_0:{rewarded:false},
					bracers_1:{rewarded:false},
					bracers_2:{rewarded:false},
					bracers_3:{rewarded:false},
				...
				currentDress:{
					...
					bracers:{currentOption:null, defaultOption:0, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1668184941" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
