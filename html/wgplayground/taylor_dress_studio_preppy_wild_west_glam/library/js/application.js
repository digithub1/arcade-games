...
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#000000";
	var _FONT = "Arial";
	var _TITLE = "Taylor Dress Studio Preppy & Wild West & Glam";
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					...
					shadows_8:{rewarded:false},
					shadows_9:{rewarded:false},
					...
					microphone_0:{rewarded:false},
					microphone_1:{rewarded:false},
					microphone_2:{rewarded:false},
					microphone_3:{rewarded:false},
					microphone_4:{rewarded:false},
					microphone_5:{rewarded:false},
					microphone_6:{rewarded:false},
					microphone_7:{rewarded:false},
					microphone_8:{rewarded:false},
					microphone_9:{rewarded:false},
					bg_0:{rewarded:false},
					bg_1:{rewarded:false}
				},
				currentDress:{
					...
					microphone:{currentOption:null, defaultOption:1, currentColor:null, defaultColor:null, currentTexture:null, defaultTexture:null, currentAlphaTexture:null, defaultAlphaTexture:1},
	...
	*/
	...
	function _onClickLocationSelectFunc(event)
	{
		...
		*/
		new Edapskov_Flickering(_before, location_mc, ["#ffff00", "#ffffcc"], 10, 24);
		...
		*/
		if(_information.heroes[hero_str].currentDress[key].currentOption != val)
		{
			...
			*/
			if(key != "bg")
			{
				new Edapskov_Flickering(_before, _action_mc[hero_str][key], ["#ffff00", "#ffffcc"], 10, 18);
	...
	*/
	...
	function _onClickSetMcDressupActionFunc(event)
	{
		...
		*/
		new Edapskov_Flickering(_before, currentTarget_mc, ["#ffff00", "#ffffcc"], 4, 18);
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1766513005" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
